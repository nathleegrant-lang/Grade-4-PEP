...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Moderate 3",
  "subtitle": "Grade 4 PEP Moderate Practice Task",
  "introduction": "Read the sources about fishing communities in Jamaica. Then answer the questions. Use details from more than one source when needed.",
  "difficultyLabel": "Moderate • Standard Grade 4 PEP level with inference and evidence use",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Life on the Water",
      "content": "Many communities along Jamaica's coast depend on fishing for their livelihoods. Fishermen go out early in the morning, often before dawn, to cast their nets or set their pots in the sea. Fish such as snapper, parrotfish, and lobster are common catches. The fish are sold at the market or from the beach, and fresh fish is an important part of many Jamaican meals."
    },
    {
      "id": 2,
      "title": "Source 2: Challenges Facing Fishermen",
      "content": "Fishing in Jamaica is not without its difficulties. Fuel for boats is expensive, and bad weather can make it dangerous to go out to sea. Overfishing in some areas means that there are fewer fish to catch than there were in the past. Some fishermen have noticed that coral reef damage has reduced the number of fish near the coast, making it harder to earn a living."
    },
    {
      "id": 3,
      "title": "Source 3: A Day's Work",
      "content": "Delroy has been fishing off the coast of St. Elizabeth for twenty years. He leaves home at 4 AM and returns by midday. 'Some days are good, some are hard,' he said. 'When the sea is rough, I stay home. When it is calm, I might bring back enough fish to feed a hundred families.' His children help him sort the catch before it is taken to the market."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what do fishermen do with the fish they catch?",
      "options": [
        "They keep all of it for themselves",
        "They sell it at the market or from the beach",
        "They donate it to schools only",
        "They freeze it and export it abroad"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 says fish are sold at the market or from the beach.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does the word 'livelihoods' most nearly mean?",
      "options": [
      ...
      "correctAnswer": 1,
      "explanation": "Livelihoods means the means by which people earn a living, which is how the word is used in Source 1 about fishing communities depending on it.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "options": [
        "Fishing in Jamaica is always easy and profitable",
        "Fishermen face real challenges that affect their daily work",
        "Jamaica has no fishing communities",
        "Fish are no longer found near Jamaica's coast"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 describes challenges like fuel costs and overfishing; Source 3 shows Delroy's days are sometimes hard and weather-dependent.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using Source 2, explain TWO challenges that Jamaican fishermen face.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 challenges",
        "Use source details"
      ],
      "reviewGuidance": "Include the high cost of fuel, dangerous weather, overfishing reducing fish numbers, and coral reef damage affecting fish near the coast.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What can you infer about Delroy from Source 3?",
      "options": [
        "He plans to stop fishing soon",
        "He finds his work unpredictable but meaningful",
        "He only fishes in good weather for fun",
        "He has no family to help him"
      ],
      "correctAnswer": 1,
      "explanation": "Delroy's comment about some days being good and some hard, and the scale of what a good day provides, shows that his work is unpredictable but important and meaningful.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "How do the sources show that fishing is important to Jamaica but also difficult? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use information from at least 2 sources",
        "Explain clearly"
      ],
      "reviewGuidance": "Use Source 1 to show importance (food, livelihoods) and Sources 2 and 3 to show the real challenges fishermen face daily.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for a community magazine about the lives of Jamaican fishermen. Use information from all three sources to explain what they do, the challenges they face, and why their work matters.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Describe their daily work",
        "Include challenges and importance",
        "Use complete sentences"
      ],
      "reviewGuidance": "Introduce fishing communities in Jamaica. Describe the challenges from Source 2. Use Delroy's story from Source 3 to bring the topic to life, and link it to the importance of fish in Jamaican life.",
      "maxScore": 12
    }
  ]
}
