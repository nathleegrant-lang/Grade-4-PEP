...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Mixed 7",
  "subtitle": "Grade 4 PEP Mixed Practice Task",
  "introduction": "Read the sources about animals and animal welfare in Jamaica. Then complete the task parts. Some parts are direct and some require deeper thinking.",
  "difficultyLabel": "Mixed • Blended difficulty for realistic exam-style preparation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Animals in Jamaican Communities",
      "content": "Many different animals live in and around Jamaican communities. Dogs, cats, goats, and chickens are common. Some animals are kept as pets or for farming. Others are stray and live on the streets. Animals play different roles in people's lives, from providing food and company to helping with work on farms."
    },
    {
      "id": 2,
      "title": "Source 2: The Importance of Animal Welfare",
      "content": "Animal welfare means making sure animals are treated well and do not suffer unnecessarily. Animals that are well cared for are healthier and safer around people. Stray animals can sometimes spread disease if they are not vaccinated or cared for. Organisations in Jamaica work to vaccinate animals, find homes for strays, and educate people about responsible pet ownership."
    },
    {
      "id": 3,
      "title": "Source 3: How Students Can Help",
      "content": "Students can play an important part in animal welfare in their communities. They can learn about responsible pet care and share that knowledge with their families. Some schools have formed animal welfare clubs that raise awareness and collect supplies for animal shelters. One student volunteer said, 'I did not realise how much difference giving an animal clean water and food every day can make.'"
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what roles do animals play in Jamaican communities?",
      "options": [
        "Only entertainment",
        "Providing food and company, and helping with farm work",
        "Only guarding homes",
        "Only religious ceremonies"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 says animals provide food and company and help with work on farms, among other roles.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what can stray animals do if they are not vaccinated?",
      "options": [
      ...
      "correctAnswer": 1,
      "explanation": "Source 2 states that stray animals can spread disease if they are not vaccinated or cared for.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the student volunteer's comment in Source 3 suggest about small acts of care?",
      "options": [
        "Only large organisations can help animals",
        "Small daily acts like providing food and water can make a meaningful difference to animals",
        "Students should not work with animals",
        "Animal welfare is too difficult for young people"
      ],
      "correctAnswer": 1,
      "explanation": "The student's comment shows that even simple actions like providing food and water daily can have a real impact, suggesting small efforts matter greatly.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using the sources, explain TWO ways that better animal welfare helps both animals and people in Jamaica.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 clear ways",
        "Use source details"
      ],
      "reviewGuidance": "Benefits include healthier animals that are safer around people, reduced disease spread, and more responsible communities through education.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Animal welfare only concerns scientists",
        "The work of organisations in Source 2 and student action in Source 3 both contribute to better animal care in communities",
        "Students cannot help with animal welfare",
        "Vaccination is the only solution to stray animals"
      ],
      "correctAnswer": 1,
      "explanation": "Both sources show different groups taking responsibility for animal welfare: organisations in Source 2 and students in Source 3.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why should students learn about animal welfare and get involved in helping animals? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your reasoning"
      ],
      "reviewGuidance": "Connect the community health benefits from Source 2 with how student action in Source 3 builds awareness and makes a real difference to animals in need.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school's community magazine explaining why animal welfare matters in Jamaica, what challenges stray animals create, and how students can help.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use facts from all three sources",
        "Include a practical conclusion"
      ],
      "reviewGuidance": "Introduce the role of animals in communities. Explain animal welfare and the risks of poor care. End with specific ways students can get involved.",
      "maxScore": 12
    }
  ]
}
