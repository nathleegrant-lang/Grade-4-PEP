...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Easy 4",
  "subtitle": "Grade 4 PEP Easy Practice Task",
  "introduction": "Read the sources about the sea around Jamaica. Then answer the questions that follow. Use the information from the sources to help you.",
  "difficultyLabel": "Easy • Clear facts, direct evidence, and simpler writing support",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Jamaica and the Sea",
      "content": "Jamaica is an island surrounded by the sea. The sea around Jamaica is called the Caribbean Sea. The water is warm and a beautiful blue-green colour. Many people enjoy swimming and fishing in the sea. The sea is very important to life in Jamaica."
    },
    {
      "id": 2,
      "title": "Source 2: Life Under the Sea",
      "content": "Many animals and plants live under the sea near Jamaica. There are colourful fish, sea turtles, dolphins, and corals. Coral reefs are like underwater gardens. They provide homes for many sea creatures. It is important to keep the sea clean so that these animals stay healthy."
    },
    {
      "id": 3,
      "title": "Source 3: The Sea and Jamaican Life",
      "content": "The sea provides many things for people in Jamaica. Fishermen catch fish to sell and eat. Tourists come to enjoy the beautiful beaches and water sports. The sea also helps ships carry goods between Jamaica and other countries. The sea is part of Jamaica's history and everyday life."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what is the sea around Jamaica called?",
      "options": [
        "The Atlantic Ocean",
        "The Pacific Sea",
        "The Caribbean Sea",
      ...
      "correctAnswer": 2,
      "explanation": "Source 1 states that the sea around Jamaica is called the Caribbean Sea.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what do coral reefs provide for sea creatures?",
      "options": [
        "Food from the land",
      ...
      "correctAnswer": 1,
      "explanation": "Source 2 says coral reefs provide homes for many sea creatures.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What do Sources 1 and 3 both say about the sea?",
      "options": [
        "It is only used for swimming",
        "It is important to life in Jamaica",
        "It is found only in the north",
        "It has no fish"
      ],
      "correctAnswer": 1,
      "explanation": "Both sources explain that the sea is important to life and everyday activities in Jamaica.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Give TWO ways that the sea is important to Jamaica. Write in complete sentences.",
      "guidelines": [
        "Write 2 complete sentences",
        "Give 2 correct ways",
        "Use your own words"
      ],
      "reviewGuidance": "Choose two clear points, such as fishing, tourism, shipping goods, or the animals and plants that live there.",
      "maxScore": 4,
    ...
    },
    {
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "Why is it important to keep the sea clean?",
      "options": [
        "So tourists can find parking",
        "So sea animals stay healthy",
        "So ships go faster",
        "So the water turns green"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 says it is important to keep the sea clean so that sea animals stay healthy.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Explain how the sea helps the people of Jamaica.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Use information from the sources"
      ],
      "reviewGuidance": "Mention fishing, tourism, water sports, and the transport of goods by ships.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a short article for your class booklet about the sea around Jamaica. Tell what the sea is like, what lives in it, and why it is important to Jamaican people.",
      "guidelines": [
        "Write at least 2 paragraphs",
        "Use facts from the sources",
        "Write in complete sentences"
      ],
      "reviewGuidance": "Introduce the Caribbean Sea and describe its appearance. Explain what lives under the water. End with how the sea supports Jamaican life and work.",
      "maxScore": 12
    }
  ]
}
