...
function CheckoutContent() {
  ...
  const handleSubmitPayment = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (latestState.activeSubscription) {
      setError(
        "Your Grade 4 access is already active. No new payment submission is needed right now.",
      )
      setSubmitting(false)
      return
    }
    ...
    setSuccess(
      "Your payment submission was received. We will verify it and activate your Grade 4 access after confirmation.",
    )
    setSubmitting(false)
  }
