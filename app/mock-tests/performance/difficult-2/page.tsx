...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Difficult 2",
  "subtitle": "Grade 4 PEP Difficult Practice Task",
  "introduction": "Read the sources about Jamaica's rainforests. Then answer the task parts. Some questions will ask you to connect ideas across the sources.",
  "difficultyLabel": "Difficult • Closer reading, stronger inference, and deeper explanation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: The Wonders of Jamaica's Rainforests",
      "content": "Jamaica's rainforests are found mainly in the Blue Mountains and the Cockpit Country. These forests are home to hundreds of plants and animals found nowhere else on Earth. The trees in a rainforest grow in layers, with the tallest trees forming a canopy that shelters everything below. Rainforests also play an important role in storing fresh water and keeping the air clean."
    },
    {
      "id": 2,
      "title": "Source 2: Why Rainforests Are Under Threat",
      "content": "Many of Jamaica's forests are being cut down to make room for farming, roads, and buildings. When trees are removed, the soil washes away in the rain, a process called erosion. Animals lose their homes and some species become endangered. Rainforests also help to control flooding, so when they are destroyed, communities nearby face greater risk from heavy rains."
    },
    {
      "id": 3,
      "title": "Source 3: Protecting What We Have",
      "content": "Several organisations in Jamaica work to protect forest areas. Schools and community groups have started tree-planting drives and nature walks to help people appreciate forests. One student from a rural school said, 'When I walked through the forest, I realised how much was living there that I had never noticed before.' Learning about forests helps people understand why they are worth protecting."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, where are Jamaica's main rainforests found?",
      "options": [
        "Near Kingston and Portmore",
        "In the Blue Mountains and Cockpit Country",
        "Along the southern coastline",
        "On the edge of Montego Bay"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 states that Jamaica's rainforests are found mainly in the Blue Mountains and the Cockpit Country.",
      "maxScore": 2
    },
    {
      "id": 2,
      "title": "Part B: Understanding Key Terms",
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does the word 'erosion' describe?",
      "options": [
        "Trees growing taller after rain",
        "Soil washing away when trees are removed",
        "Animals moving to new areas",
        "Flooding in city streets"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 explains that erosion is when soil washes away after trees are removed.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the student's comment in Source 3 suggest about learning through experience?",
      "options": [
        "Nature walks are too difficult for young students",
        "Visiting forests helps people discover things they would not notice otherwise",
        "Students prefer reading about forests to visiting them",
        "Animals in forests can be dangerous"
      ],
      "correctAnswer": 1,
      "explanation": "The student noticed things they had never seen before, showing that direct experience can open one's eyes to what is already there.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Explain TWO ways that cutting down rainforests can harm people or communities.",
      "guidelines": [
        "Write 2–3 complete sentences",
        "Give 2 clear examples of harm",
        "Use details from the sources"
      ],
      "reviewGuidance": "Consider effects such as flooding, erosion, loss of clean water, and threats to farming or local communities.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Rainforests have no effect on water or soil",
        "The Blue Mountains are not threatened by human activity",
        "The benefits rainforests provide are put at risk when they are destroyed",
        "All Jamaican wildlife lives only in rainforests"
      ],
      "correctAnswer": 2,
      "explanation": "Source 1 explains the benefits of rainforests; Source 2 shows what is lost when those forests are cut down.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why should students learn about Jamaica's rainforests? Use information from at least TWO sources to support your answer.",
      "guidelines": [
        "Write 3–4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your thinking, not just list facts"
      ],
      "reviewGuidance": "Show how rainforests benefit people (water, air, wildlife) and why student awareness can lead to action that protects them.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a report for your school newsletter explaining why Jamaica's rainforests are important, what threatens them, and what students can do to help. Use all three sources in your response.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use information from all 3 sources",
        "Explain ideas, not just list them",
        "Use complete sentences and organise your ideas clearly"
      ],
      "reviewGuidance": "Begin by explaining what makes rainforests valuable. Then describe the threats clearly. End with realistic actions students and communities can take.",
      "maxScore": 12
    }
  ]
}
