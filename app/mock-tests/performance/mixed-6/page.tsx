...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Mixed 6",
  "subtitle": "Grade 4 PEP Mixed Practice Task",
  "introduction": "Read the sources about community cleanliness in Jamaica. Then complete the task parts. Some parts are direct and some require deeper thinking.",
  "difficultyLabel": "Mixed • Blended difficulty for realistic exam-style preparation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Why Clean Communities Matter",
      "content": "A clean community is important for the health and wellbeing of everyone who lives there. Rubbish left in streets and yards can block drains and cause flooding. It can attract insects and animals that carry disease. A clean environment also makes communities more pleasant to live in and can encourage people to take pride in where they live."
    },
    {
      "id": 2,
      "title": "Source 2: Challenges in Keeping Communities Clean",
      "content": "Keeping communities clean is not always easy. Some areas do not have enough rubbish bins or regular waste collection. People may litter because they do not think about the consequences or because they do not feel ownership over public spaces. Without proper waste disposal services, rubbish can build up quickly in streets and open spaces."
    },
    {
      "id": 3,
      "title": "Source 3: Students Making a Difference",
      "content": "At many schools across Jamaica, students take part in community clean-up campaigns. They collect litter, clear drains, and create posters to remind people not to litter. One community leader noted that when young people are involved in caring for their environment, they often inspire adults to do the same. These campaigns help students understand their responsibility to the places they live."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what can rubbish in streets and yards cause?",
      "options": [
        "Better air quality",
      ...
      "correctAnswer": 1,
      "explanation": "Source 1 states that rubbish left in streets and yards can block drains and cause flooding.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, why do some people litter?",
      "options": [
        "Because it is the law",
        "Because bins are too expensive",
        "Because they do not think about consequences or do not feel ownership over public spaces",
        "Because they enjoy it"
      ],
      "correctAnswer": 2,
      "explanation": "Source 2 says people may litter because they do not think about consequences or do not feel ownership over public spaces.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the community leader's comment in Source 3 suggest about young people's influence?",
      "options": [
        "Young people cannot help with community problems",
        "Student involvement in caring for the environment can inspire adults to act",
        "Adults are always better role models than students",
        "Clean-up campaigns do not work"
      ],
      "correctAnswer": 1,
      "explanation": "The leader says young people involved in caring for the environment often inspire adults, showing that students can lead by example.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using the sources, explain TWO reasons why it can be difficult to keep Jamaican communities clean.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 clear reasons",
        "Use source details"
      ],
      "reviewGuidance": "Include lack of bins or collection services, littering habits, no sense of ownership over public spaces, and the effects of insufficient waste disposal.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Cleanliness has no connection to health",
        "The health and pride benefits of cleanliness described in Source 1 help explain why student clean-up efforts in Source 3 are valuable",
        "Students only clean schools, not communities",
        "Flooding cannot be prevented by removing rubbish"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 explains why cleanliness matters; Source 3 shows students actively working toward those same goals in their communities.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why should students be involved in keeping their communities clean? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your ideas clearly"
      ],
      "reviewGuidance": "Connect the real health and environmental benefits from Source 1 with the leadership and inspiration role that student action plays in Source 3.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a persuasive article for your school newsletter encouraging students to take part in keeping their community clean. Use all three sources to explain why cleanliness matters, the challenges, and what students can do.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use facts from all three sources",
        "Include a strong conclusion"
      ],
      "reviewGuidance": "Open with the importance of a clean environment. Address challenges honestly. End with a strong call to action using examples from Source 3.",
      "maxScore": 12
    }
  ]
}
