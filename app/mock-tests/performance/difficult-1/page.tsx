...
const performanceTask: PerformanceTaskSet = {
  ...
  "introduction": "Read the sources about protecting Jamaica's beaches. Then answer the task parts. Some questions will require you to connect ideas across the sources.",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Why Beaches Matter",
      "content": "Jamaica's beaches are important for many reasons. They provide places for families to relax, attract visitors, and support local jobs. Beaches also protect the land by helping to slow the force of waves. Plants such as sea grape and mangrove help hold the sand and soil in place."
    },
    {
      "id": 2,
      "title": "Source 2: Threats to the Coast",
      "content": "Many beaches are under pressure from littering, careless building, and stronger storms. When too much sand is removed or plants are destroyed, the coastline can wear away more quickly. This process is called erosion. Erosion can damage homes, roads, and habitats for animals."
    },
    {
      "id": 3,
      "title": "Source 3: Students Take Action",
      "content": "At one school, students started a 'Protect Our Beach' project. They made posters, spoke to community members, and helped with clean-up days. Their teacher said the project did not solve everything at once, but it helped students understand that small actions can lead to bigger change over time."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, how do mangroves and sea grape plants help the coast?",
      "options": [
        "They make the water warmer",
        "They hold sand and soil in place",
        "They turn waves away completely",
        "They remove litter from beaches"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 explains that these plants help hold the sand and soil in place.",
      "maxScore": 2
    },
    {
      "id": 2,
      "title": "Part B: Understanding a Process",
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does the word 'erosion' describe?",
      "options": [
        "A type of fish",
        "The wearing away of the coastline",
        "A community clean-up",
        "A new road near the beach"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 defines erosion as the coastline wearing away more quickly.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What idea is suggested by the teacher's comment in Source 3?",
      "options": [
        "Students should stop trying when change is slow",
        "Big problems can never be improved",
        "Small actions can still be important",
        "Only adults should protect beaches"
      ],
      "correctAnswer": 2,
      "explanation": "The teacher says small actions can lead to bigger change over time, showing that small efforts matter.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Explain TWO problems that can happen when beaches are not protected.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 clear problems",
        "Use source details"
      ],
      "reviewGuidance": "You might mention erosion, damage to roads or homes, or harm to habitats and jobs that depend on beaches.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Beaches are not useful to Jamaica",
        "Natural plants help protect beaches from damage",
        "Stronger storms always improve the coast",
        "Roads are built from beach sand"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 explains the protective role of plants, and Source 2 shows what happens when protection is removed.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why is it important for students to learn about protecting beaches? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your thinking"
      ],
      "reviewGuidance": "Show that beaches matter for people, jobs, and protection from waves, and explain how student action can support change.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school magazine encouraging students to protect Jamaica's beaches. Use all three sources to explain why beaches matter, what threatens them, and what students can do.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use information from all 3 sources",
        "Explain, not just list facts",
        "Use complete sentences"
      ],
      "reviewGuidance": "Introduce why beaches matter, explain the threats, and finish with realistic actions students can take.",
      "maxScore": 12
    }
  ]
}
      ...
      if (typeof answer === "string" && answer.trim()) {
        if (part.type === "extended-writing") {
          if (answer.trim().length > 220) {
            score += Math.round(part.maxScore * 0.75)
          } else if (answer.trim().length > 120) {
            score += Math.round(part.maxScore * 0.5)
          } else {
            score += Math.round(part.maxScore * 0.25)
          }
          return
        }
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-amber-700">
                          You can try {FREE_PARTS_LIMIT} parts for free. Upgrade to Premium for the full performance task with the branded report.
                        </p>
                      </div>
                    </div>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="rounded-xl border border-amber-200 bg-amber-50 p-5 text-left">
                  ...
                  <p className="text-sm text-slate-700">
                    This difficult performance task report includes section summaries, multiple-choice results, written responses, and teacher-style guidance. Then print or save the report as a PDF with the logo.
                  </p>
                </div>
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <CardTitle className="text-2xl text-amber-800 mt-1">
                      Grade 4 PEP Performance Task Report
                    </CardTitle>
                    ...
                    >
                      <div className="flex items-start gap-3">
                        {taskPart.type === "multiple-choice" ? (
                          ...
                          <ClipboardList className="h-5 w-5 text-amber-600 mt-1 flex-shrink-0" />
                        )}
                            ...
                            <div className="space-y-1 text-sm">
                              <p className="text-slate-700">
                                ...
                                <span className={isCorrect ? "text-green-700 font-medium" : "text-red-700 font-medium"}>
                                  {answers[index] !== null ? taskPart.options[answers[index] as number] : "Not answered"}
                                </span>
                              </p>
                              <p className="text-green-700">
                                <span className="font-medium">Correct Answer:</span>{" "}
                                {taskPart.options[taskPart.correctAnswer!]}
                              </p>
                              {taskPart.explanation && (
                                <p className="text-slate-700 mt-2">
                                  <span className="font-medium">Explanation:</span> {taskPart.explanation}
                                </p>
                              )}
                            </div>
                          )}
                          ...
                          {(taskPart.type === "short-answer" || taskPart.type === "extended-writing") && (
                            <div className="space-y-3 text-sm">
                              <div>
                                ...
                                <div className="rounded-lg border bg-white p-3 text-slate-700 whitespace-pre-line">
                                  {answers[index] || <span className="italic text-slate-400">No response provided</span>}
                                </div>
                              </div>
                              ...
                              <div className="rounded-lg border border-amber-100 bg-white p-3">
                                ...
                                <p className="text-slate-700">
                                  {taskPart.reviewGuidance || "Use evidence from the sources, organize ideas clearly, and write in complete sentences."}
                                </p>
                              </div>
                            </div>
                          )}
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold">{performanceTask.title}</h1>
              ...
              <div className="space-y-4">
                {performanceTask.sources.map((source) => (
                  <Card key={source.id} className="border-gray-200">
                    ...
                    <CardContent className="text-sm text-gray-700 whitespace-pre-line max-h-56 overflow-y-auto">
                      {source.content}
                    </CardContent>
                  </Card>
                ))}
                ...
                <CardContent className="p-6">
                  ...
                  {part.guidelines && (
                    <div className="mb-4 p-3 bg-amber-50 rounded-lg">
                      ...
                      <ul className="text-sm text-gray-700 space-y-1">
                        {part.guidelines.map((guideline, i) => (
