...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Easy 8",
  "subtitle": "Grade 4 PEP Easy Practice Task",
  "introduction": "Read the sources about school life in Jamaica. Then answer the questions that follow. Use the information from the sources to help you.",
  "difficultyLabel": "Easy • Clear facts, direct evidence, and simpler writing support",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Going to School",
      "content": "Children in Jamaica go to school to learn and grow. School helps children read, write, count, and understand the world around them. In Jamaica, children start primary school at age six. Students learn many subjects including Mathematics, Language Arts, Science, and Social Studies. Going to school every day helps students build a better future."
    },
    {
      "id": 2,
      "title": "Source 2: Activities at School",
      "content": "School is not only about lessons. Students also take part in sports, music, art, and drama. Many schools have a school garden where students grow plants and learn about nature. Students learn to work together as a team. These activities help students develop new skills and build friendships."
    },
    {
      "id": 3,
      "title": "Source 3: Why Education Matters",
      "content": "Education is very important in Jamaica. When children learn well at school, they can go on to do jobs that help their communities. Teachers play a big role in helping students succeed. Parents and families also support children's learning. A good education opens many doors for young people in Jamaica."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, at what age do children in Jamaica start primary school?",
      "options": [
        "Age four",
        "Age five",
        "Age six",
      ...
      "correctAnswer": 2,
      "explanation": "Source 1 states that children start primary school at age six in Jamaica.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what do students do in a school garden?",
      "options": [
        "Cook meals for the class",
        "Grow plants and learn about nature",
        "Play sports and games",
        "Draw pictures of animals"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 says students grow plants and learn about nature in the school garden.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What do Sources 1 and 3 both suggest about school?",
      "options": [
        "School is only useful for learning Mathematics",
        "School only matters for older students",
        "School helps children build a better future",
        "School is not important in Jamaica"
      ],
      "correctAnswer": 2,
      "explanation": "Source 1 says school helps build a better future, and Source 3 says education opens many doors for young people.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Give TWO things students learn or do at school in Jamaica. Write in complete sentences.",
      "guidelines": [
        "Write 2 complete sentences",
        "Give 2 correct points",
        "Use your own words"
      ],
      "reviewGuidance": "Choose two clear points, such as subjects studied, school activities like sports or art, gardening, or working in teams.",
      "maxScore": 4,
    ...
    },
    {
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "Who helps children succeed at school?",
      "options": [
        "Only the head teacher",
        "Only older students",
        "Teachers, parents, and families",
        "Government ministers only"
      ],
      "correctAnswer": 2,
      "explanation": "Source 3 says that teachers and parents and families all support children's learning and help them succeed.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Explain why education is important for children in Jamaica.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Use information from the sources"
      ],
      "reviewGuidance": "Mention that school helps children read, write, and count, build skills, and go on to do jobs that help their communities.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a short article for your class booklet about school life in Jamaica. Tell what students learn, what activities they enjoy, and why education is important.",
      "guidelines": [
        "Write at least 2 paragraphs",
        "Use facts from the sources",
        "Write in complete sentences"
      ],
      "reviewGuidance": "Start with what students learn at school and the subjects they study. Describe the activities they enjoy. End by explaining how a good education helps young Jamaicans.",
      "maxScore": 12
    }
  ]
}
