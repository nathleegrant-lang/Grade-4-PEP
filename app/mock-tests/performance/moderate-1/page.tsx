...
const performanceTask: PerformanceTaskSet = {
  ...
  "introduction": "Read the sources about Jamaica's market vendors. Then answer the questions. Use details from more than one source when needed.",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Market Morning",
      "content": "Every Saturday, vendors arrive early at the market. Some bring vegetables, fruits, spices, and baked goods. They arrange their stalls carefully so customers can see the best items first. By 8 o'clock, the market is full of people shopping, talking, and listening to vendors call out prices."
    },
    {
      "id": 2,
      "title": "Source 2: Why Markets Matter",
      "content": "Markets are important because they give farmers and small business owners a place to sell their goods. Customers can buy fresh food and support local families at the same time. Markets also help keep community traditions alive, because people meet there, share news, and enjoy local foods."
    },
    {
      "id": 3,
      "title": "Source 3: A Young Helper",
      "content": "Keisha helps her grandmother at a fruit stall every weekend. She weighs oranges, counts change, and greets customers politely. At first, she thought the work was tiring. Later, she said the market helped her become more confident and responsible."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, why do vendors arrange their stalls carefully?",
      "options": [
        "To hide their goods",
        "To make customers see the best items first",
        "To keep children away",
        "To save time at home"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 says vendors arrange stalls so customers can see the best items first.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does the word 'traditions' most nearly mean?",
      "options": [
        "Old ways people continue to follow",
        "Very expensive items",
        "Rules for parking",
        "Things that break easily"
      ],
      "correctAnswer": 0,
      "explanation": "In this context, traditions means customs or old ways that people continue.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What idea is supported by both Source 2 and Source 3?",
      "options": [
        "Markets only help tourists",
        "Markets can help families and communities",
        "Markets are always noisy and unsafe",
        "Young people should not help at markets"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 shows markets support local families and communities, and Source 3 shows Keisha learning and helping her family.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using Source 2, explain TWO reasons markets are important in Jamaica.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 reasons",
        "Use source details"
      ],
      "reviewGuidance": "Mention reasons such as helping small business owners, giving customers fresh food, or keeping community traditions alive.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What can you infer about Keisha from Source 3?",
      "options": [
        "She dislikes helping people",
        "She is learning useful life skills",
        "She wants to leave the market forever",
        "She cannot count money"
      ],
      "correctAnswer": 1,
      "explanation": "Because she weighs fruit, counts change, and grows in confidence, we can infer she is learning useful skills.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "How do the sources show that markets do more than just sell goods? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use information from at least 2 sources",
        "Explain clearly"
      ],
      "reviewGuidance": "Explain that markets support families, keep traditions alive, and help young people like Keisha build responsibility and confidence.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school newsletter about why local markets are important. Use information from all three sources.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Explain what happens at the market",
        "Show why markets matter to Jamaica",
        "Use complete sentences"
      ],
      "reviewGuidance": "Introduce the market, explain its value to sellers and communities, and include an example such as Keisha's experience.",
      "maxScore": 12
    }
  ]
}
              ...
              <div className="text-center space-y-6">
                ...
                <div className="rounded-xl border border-amber-200 bg-amber-50 p-5 text-left">
                  ...
                  <p className="text-sm text-slate-700">
                    This moderate performance task report includes section summaries, multiple-choice results, written responses, and teacher-style guidance. Then print or save the report as a PDF with the logo.
                  </p>
                </div>
