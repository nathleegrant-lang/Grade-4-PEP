...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Mixed 3",
  "subtitle": "Grade 4 PEP Mixed Practice Task",
  "introduction": "Read the sources about libraries and reading in Jamaica. Then complete the task parts. Some parts are direct and some require deeper thinking.",
  "difficultyLabel": "Mixed • Blended difficulty for realistic exam-style preparation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: The Role of Libraries",
      "content": "Libraries are important places in every community. They provide books, magazines, and other resources for people to read and learn. In Jamaica, public libraries can be found in most parishes. Libraries give everyone access to information, whether they are students, workers, or older members of the community."
    },
    {
      "id": 2,
      "title": "Source 2: Why Reading Matters",
      "content": "Reading regularly helps people improve their vocabulary, understanding, and ability to write. Children who read often tend to do better in school. Reading can also be enjoyable and help people relax. Books allow readers to learn about different places, people, and ideas without leaving their homes."
    },
    {
      "id": 3,
      "title": "Source 3: Reading Programmes in Schools",
      "content": "Many schools in Jamaica run reading programmes to encourage students to read more. These programmes may include reading clubs, book fairs, and competitions. One school librarian said that when students are given a choice of books they enjoy, they read more freely and with greater confidence. Creating a love of reading early helps students throughout their lives."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, who can use a library?",
      "options": [
        "Only school students",
        "Only teachers",
        "Only adults",
        "Students, workers, and older community members"
      ],
      "correctAnswer": 3,
      "explanation": "Source 1 says libraries give everyone access to information, whether students, workers, or older community members.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, how does reading help children at school?",
      "options": [
        "It replaces homework",
        "Children who read often tend to do better in school",
        "It makes lessons shorter",
        "It only helps with Mathematics"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 states that children who read often tend to do better in school.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the librarian's comment in Source 3 suggest about encouraging reading?",
      "options": [
        "Students should only read books chosen by teachers",
        "Giving students a choice of books they enjoy leads to more confident reading",
        "Book fairs are the only way to improve reading",
        "Reading competitions are harmful"
      ],
      "correctAnswer": 1,
      "explanation": "The librarian says students read more freely and confidently when they choose books they enjoy, showing that choice supports reading culture.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using the sources, explain TWO ways that reading or libraries help people in Jamaica.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 ways",
        "Use source details"
      ],
      "reviewGuidance": "Include benefits such as access to information for all, improved school performance, vocabulary growth, enjoyment, and relaxation.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Libraries are not useful to students",
        "Libraries provide the resources that school reading programmes depend on",
        "Reading programmes work without books",
        "Libraries are only for adults"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 describes libraries as resource providers; Source 3 shows how school programmes use those resources to build reading culture.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why is it important for schools to encourage a love of reading? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your ideas clearly"
      ],
      "reviewGuidance": "Link improved school performance and vocabulary from Source 2 with the lasting benefits of early reading habits described in Source 3.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school magazine explaining why reading is important, how libraries support the community, and how students can develop a love of reading.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use facts from all three sources",
        "Include a clear conclusion"
      ],
      "reviewGuidance": "Open with why reading matters. Explain the role of libraries and school programmes. End with practical advice students can follow to read more.",
      "maxScore": 12
    }
  ]
}
