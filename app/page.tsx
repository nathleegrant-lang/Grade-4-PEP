...
const HERO_IMAGE = "https://images.pexels.com/photos/5905961/pexels-photo-5905961.jpeg?auto=compress&dpr=1&h=900&w=1400"
        ...
        <div className="container relative mx-auto grid gap-10 px-4 py-14 md:grid-cols-2 md:items-center md:py-20">
          <div>
            <div className="mb-5 flex items-center gap-3">
              <span className="text-xl font-black tracking-tight md:text-2xl">PEP PRACTICE</span>
            ...
            <p className="mb-3 font-semibold text-blue-100">Practice • Review • Confidence</p>
            ...
            <p className="mt-5 max-w-xl text-lg leading-relaxed text-blue-50">Online Grade 4 practice that helps learners review key skills, practise with purpose, and build confidence through focused digital learning.</p>
          ...
          <div className="relative mx-auto w-full max-w-lg">
            <div className="overflow-hidden rounded-[2rem] border-4 border-white/20 bg-white/10 shadow-2xl">
              <img src={HERO_IMAGE} alt="Grade 4 learner using a laptop for online educational practice" className="h-[360px] w-full object-cover md:h-[430px]" />
            </div>
            <div className="absolute -bottom-5 left-4 right-4 rounded-2xl bg-white p-4 text-slate-900 shadow-xl sm:left-auto sm:w-72">
              <p className="text-xs font-black uppercase tracking-wider text-pink-600">PEP PRACTICE — GRADE 4</p>
              <p className="mt-1 font-bold text-blue-950">Focused online practice at home.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <section className="bg-white py-14 md:py-16">
          <div className="container mx-auto px-4">
            <div className="grid gap-8 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
              <div className="overflow-hidden rounded-3xl shadow-xl"><img src={STUDENT_IMAGE} alt="Grade 4 learner engaged with online practice on a laptop" className="h-[320px] w-full object-cover md:h-[420px]" loading="lazy" /></div>
              <div>
                ...
                <p className="mt-4 max-w-2xl text-lg leading-relaxed text-slate-600">Work through Grade 4 Language Arts, Mathematics, Performance Tasks and mock-style practice online. Review what you know, keep practising, and build confidence one step at a time.</p>
        ...
        <section className="bg-blue-50 py-14 md:py-16">
          <div className="container mx-auto grid gap-8 px-4 lg:grid-cols-2 lg:items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="mt-4 max-w-xl text-lg leading-relaxed text-slate-600">Support your child’s Grade 4 learning with focused online practice. Use the progress information already available in the platform to see what has been completed and encourage additional practice where it may be useful.</p>
              <div className="mt-5 space-y-3">{["Support a regular online practice routine", "Review completed learning activity", "Encourage more practice in selected areas"].map((item) => <div key={item} className="flex items-center gap-3 font-medium text-slate-700"><CheckCircle2 className="h-5 w-5 flex-none text-emerald-600" />{item}</div>)}</div>
            ...
            <div className="order-1 overflow-hidden rounded-3xl shadow-xl lg:order-2"><img src={PARENT_IMAGE} alt="Parent supporting a child using a laptop for online learning" className="h-[320px] w-full object-cover md:h-[430px]" loading="lazy" /></div>
          </div>
        </section>

        <section className="bg-white py-14">
          <div className="container mx-auto px-4">
            <div className="mx-auto mb-8 max-w-2xl text-center"><p className="font-bold uppercase tracking-[0.18em] text-blue-700">PEP PRACTICE — GRADE 4</p><h2 className="mt-2 text-3xl font-black text-blue-950">How to Use This Site</h2><p className="mt-3 text-slate-600">A simple path to purposeful online practice.</p></div>
