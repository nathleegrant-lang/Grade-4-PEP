...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Difficult 10",
  "subtitle": "Grade 4 PEP Difficult Practice Task",
  "introduction": "Read the sources about Jamaica's wildlife and biodiversity. Then answer the task parts. Some questions will ask you to connect ideas and think carefully about what the sources mean.",
  "difficultyLabel": "Difficult • Closer reading, stronger inference, and deeper explanation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Jamaica's Unique Wildlife",
      "content": "Jamaica is home to an extraordinary variety of plants and animals. Because of the island's isolation from the mainland, many species evolved here and are found nowhere else on Earth. These are known as endemic species. Jamaica's most famous endemic bird is the Streamer-tailed Hummingbird, also called the Doctor Bird, which is the national bird. The island also has unique lizards, frogs, bats, butterflies, and flowering plants. This richness of life is what scientists call biodiversity."
    },
    {
      "id": 2,
      "title": "Source 2: Threats to Jamaica's Natural World",
      "content": "Jamaica's biodiversity is under serious threat. Habitat destruction caused by deforestation, urban development, and farming reduces the space that animals and plants need to survive. Invasive species, meaning animals or plants brought from other places, can outcompete local species for food and space. The illegal wildlife trade, where animals are captured and sold, threatens populations of rare species. Climate change is also altering habitats in ways that many species cannot adapt to quickly enough."
    },
    {
      "id": 3,
      "title": "Source 3: Youth Wildlife Guardians",
      "content": "Several nature organisations in Jamaica run programmes that bring school students into natural habitats to learn about local wildlife. Students observe animals in the field, help count species populations, and learn to identify bird calls and plant types. One young participant said, 'Before the programme, I thought wildlife was something far away. Now I know it is all around us.' These experiences inspire students to become advocates for protecting Jamaica's natural world."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what does the term 'endemic species' mean?",
      "options": [
        "Species that have been brought to Jamaica from other countries",
        "Species found only in Jamaica and nowhere else on Earth",
        "Species that are common all across the Caribbean",
        "Species that are kept in zoos for protection"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 defines endemic species as those that evolved in Jamaica and are found nowhere else on Earth.",
      "maxScore": 2
    },
    {
      "id": 2,
      "title": "Part B: Understanding a Threat",
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what are 'invasive species'?",
      "options": [
        "Animals that move from one part of Jamaica to another",
        "Plants and animals brought from other places that outcompete local species",
        "Species that are protected by the Jamaican government",
        "Endemic birds that are endangered"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 defines invasive species as animals or plants brought from other places that can outcompete local species.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the student's comment in Source 3 suggest about many students' awareness of local wildlife?",
      "options": [
        "Most students study wildlife every day at school",
        "Students often do not realise that wildlife exists close to where they live",
        "Wildlife in Jamaica is only found in national parks",
        "Young people prefer studying animals from other countries"
      ],
      "correctAnswer": 1,
      "explanation": "The student's comment shows they previously thought wildlife was distant, suggesting many students are unaware of the wildlife in their own surroundings.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Explain TWO threats to Jamaica's wildlife and why they are serious.",
      "guidelines": [
        "Write 2–3 complete sentences",
        "Name and explain 2 threats",
        "Use details from the sources"
      ],
      "reviewGuidance": "Think about habitat destruction, invasive species, the illegal wildlife trade, and climate change, and explain the consequences of each.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "Which statement best connects Source 1 and Source 2?",
      "options": [
        "Endemic species are not affected by habitat loss",
        "Jamaica's unique wildlife described in Source 1 is put at risk by the threats described in Source 2",
        "Invasive species help endemic species to grow",
        "Biodiversity only matters in countries larger than Jamaica"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 shows how special Jamaica's wildlife is; Source 2 shows how that uniqueness is under threat.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why should students in Jamaica care about protecting wildlife and biodiversity? Use information from at least TWO sources to support your answer.",
      "guidelines": [
        "Write 3–4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your reasoning"
      ],
      "reviewGuidance": "Connect the uniqueness and value of Jamaica's biodiversity with how student involvement in programmes like those in Source 3 can build awareness and advocacy.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for a nature magazine encouraging students in Jamaica to learn about and protect local wildlife. Use all three sources in your response.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use information from all 3 sources",
        "Give reasons and examples to support your argument",
        "Use complete sentences"
      ],
      "reviewGuidance": "Open with what makes Jamaica's wildlife special and worth protecting. Describe the threats clearly. End by describing how student participation in wildlife programmes can make a real difference.",
      "maxScore": 12
    }
  ]
}
