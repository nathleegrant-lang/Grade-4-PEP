...
const performanceTask: PerformanceTaskSet = {
  ...
  "sources": [
    {
      "id": 1,
      "title": "Source 1: What is Rainwater Harvesting?",
      "content": "Rainwater harvesting is the collection and storage of rain for later use. Some homes and schools use gutters and tanks to catch rainwater from roofs. This water can be used for cleaning, watering plants, and sometimes other needs after proper treatment."
    },
    {
      "id": 2,
      "title": "Source 2: Why It Helps",
      "content": "Rainwater harvesting can help during dry weather, especially when water supplies are low. It can also lower water bills and reduce the amount of water that runs quickly off the land after heavy rain. In some communities, stored rainwater has helped gardens continue to grow during dry spells."
    },
    {
      "id": 3,
      "title": "Source 3: A School Project",
      "content": "Students at one primary school worked with teachers to start a rainwater harvesting project. They learned how the system worked and created posters to teach others. The principal said the project helped the school save water and helped students understand how people can care for natural resources in practical ways."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, where is rainwater often collected from?",
      "options": [
        "Roads",
        "Roofs",
        "Rivers",
      ...
      "correctAnswer": 1,
      "explanation": "Source 1 says gutters and tanks catch rainwater from roofs.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what is one benefit of rainwater harvesting?",
      "options": [
        "It stops all storms",
        "It can lower water bills",
        "It turns salt water fresh",
        "It removes every drought"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 states that rainwater harvesting can lower water bills.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What can you infer about the school project in Source 3?",
      "options": [
        "It taught students practical ways to care for resources",
        "It was only about making posters",
        "It failed to help the school",
        "It was too difficult for students to understand"
      ],
      "correctAnswer": 0,
      "explanation": "The principal says the project helped students understand practical ways to care for natural resources.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using the sources, explain TWO ways rainwater harvesting can help a school or community.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 useful ways",
        "Use source details"
      ],
      "reviewGuidance": "Possible answers include saving water, lowering bills, helping gardens, or providing water during dry spells.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Rainwater harvesting only helps homes",
        "Rainwater harvesting can support both saving resources and learning",
        "Students should not help with community projects",
        "Stored water is never useful"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 explains practical benefits, while Source 3 shows students learning through a real project.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why should more schools learn about rainwater harvesting? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your ideas clearly"
      ],
      "reviewGuidance": "Show both practical benefits and learning benefits, such as saving water and teaching responsibility.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for a school environment booklet about rainwater harvesting. Explain what it is, why it helps, and how schools can benefit from learning about it.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use facts from the sources",
        "Include a clear conclusion"
      ],
      "reviewGuidance": "Define rainwater harvesting, explain practical benefits, and show how schools and students can benefit from using and learning about it.",
      "maxScore": 12
    }
  ]
}
