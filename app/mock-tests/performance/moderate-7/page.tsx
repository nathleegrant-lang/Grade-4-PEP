...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Moderate 7",
  "subtitle": "Grade 4 PEP Moderate Practice Task",
  "introduction": "Read the sources about Jamaican food and cooking culture. Then answer the questions. Use details from more than one source when needed.",
  "difficultyLabel": "Moderate • Standard Grade 4 PEP level with inference and evidence use",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Jamaica's Food Heritage",
      "content": "Jamaican cuisine is known around the world. Dishes such as jerk chicken, ackee and saltfish, rice and peas, and curry goat have roots in Africa, India, China, and Europe, reflecting Jamaica's history. Food in Jamaica is often seasoned with herbs and spices such as scotch bonnet pepper, allspice, and thyme. These flavours give Jamaican food its distinctive taste and character."
    },
    {
      "id": 2,
      "title": "Source 2: Food as Community",
      "content": "In Jamaica, food is often at the centre of community and family life. Sunday dinners, festival celebrations, and church events all feature traditional cooking. Grandmothers and mothers are often the keepers of family recipes that are passed down without ever being written. Cooking together strengthens family bonds and keeps traditions alive. Many Jamaicans living abroad cook traditional dishes to stay connected to their homeland."
    },
    {
      "id": 3,
      "title": "Source 3: Young Cooks",
      "content": "A primary school in Manchester started a cooking club where students learn to prepare traditional Jamaican recipes. One student, Tanya, made festival bread for the first time and was surprised by how many steps were involved. 'I thought it was just flour and water,' she said. Her teacher explained that learning to cook builds independence, maths skills, and an appreciation for Jamaican culture."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, which of the following is a herb or spice used in Jamaican cooking?",
      "options": [
        "Cinnamon and nutmeg",
      ...
      "correctAnswer": 1,
      "explanation": "Source 1 lists scotch bonnet pepper, allspice, and thyme as herbs and spices used in Jamaican food.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does 'distinctive' most nearly mean?",
      "options": [
        "Very common and ordinary",
        "Easily recognisable or different from others",
        "Difficult to eat",
        "Too spicy for most people"
      ],
      "correctAnswer": 1,
      "explanation": "Distinctive means easily recognisable or noticeably different from others, which is how it is used to describe Jamaican food's unique taste.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "options": [
        "Food in Jamaica is only eaten at special events",
        "Cooking and food traditions can strengthen identity and teach important skills",
        "Students should not learn to cook at school",
        "Traditional recipes must always be written down"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 shows cooking as a way of keeping traditions and family bonds alive; Source 3 shows a school cooking club building cultural appreciation and practical skills.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using Source 2, explain TWO ways that food plays an important role in Jamaican community and family life.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 ways",
        "Use source details"
      ],
      "reviewGuidance": "Include Sunday dinners and community events, passing down recipes between generations, strengthening family bonds, and Jamaicans abroad staying connected through food.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What can you infer about Tanya from Source 3?",
      "options": [
        "She had cooked festival bread many times before",
        "She underestimated how much skill traditional cooking involves",
        "She did not enjoy the cooking club",
        "She already knew every Jamaican recipe"
      ],
      "correctAnswer": 1,
      "explanation": "Tanya's surprise at the steps involved in making festival bread shows she had underestimated the skill and knowledge that traditional cooking requires.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "How do the sources show that Jamaican food is about more than just eating? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use information from at least 2 sources",
        "Explain clearly"
      ],
      "reviewGuidance": "Connect the cultural heritage and community bonds from Sources 1 and 2 with the skills and appreciation built through the school cooking club in Source 3.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school magazine about Jamaican food and why cooking traditions are important. Use information from all three sources.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Explain Jamaica's food heritage",
        "Show why food traditions matter",
        "Use complete sentences"
      ],
      "reviewGuidance": "Introduce Jamaican cuisine and its heritage. Explain how food builds family and community bonds. End with how young people can learn and continue these traditions.",
      "maxScore": 12
    }
  ]
}
