...
const numeracyMixed8Questions: Question[] = [
  {
    id: 1,
    type: "number",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: `3/4 = 6/8. 7/8 - 6/8 = 1/8.`
  },
  {
    id: 6,
    type: "number",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: `(3.8 + 4.6) / 2 = 8.4 / 2 = 4.2.`
  },
  {
    id: 11,
    type: "number",
    ...
    correctAnswer: 2,
    explanation: `Per person: 80 g. For 7: 80 x 7 = 560 g.`
  },
  {
    id: 12,
    type: "number",
    question: `What is 7.2 divided by 0.09?`,
    options: [
      "8",
      "80",
      "800",
  ...
  },
  {
    id: 13,
    type: "number",
    question: `In a class, the ratio of boys to girls is 4:3. There are 28 boys. How many students altogether?`,
    options: [
      "42",
      "49",
      "56",
    ...
    correctAnswer: 1,
    explanation: `If 4 parts = 28, then 1 part = 7. Girls = 21. Total = 28 + 21 = 49.`
  },
  {
    id: 14,
    type: "number",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: `First 3 primes: 2, 3, 5. Product = 30.`
  },
  {
    id: 16,
    type: "measurement",
    question: `A rectangle has area 90 cm2 and length 15 cm. What is its width?`,
    options: [
      "5 cm",
      "6 cm",
      "7 cm",
  ...
  },
  {
    id: 17,
    type: "measurement",
    question: `A journey takes 4 hours 20 minutes and ends at 7:05 PM. When did it start?`,
    options: [
      "2:35 PM",
      "2:45 PM",
      "3:00 PM",
    ...
    correctAnswer: 1,
    explanation: `7:05 PM minus 4 h 20 min: 7:05 - 4 h = 3:05. 3:05 - 20 min = 2:45 PM.`
  },
  {
    id: 18,
    type: "measurement",
    ...
    correctAnswer: 2,
    explanation: `1 L = 1,000 cm3. 2.5 x 1,000 = 2,500 cm3.`
  },
  {
    id: 19,
    type: "measurement",
    question: `A field in the shape of a parallelogram has base 20 m and height 14 m. What is its area?`,
    options: [
      "34 m2",
      "140 m2",
      "280 m2",
    ...
    correctAnswer: 2,
    explanation: `Area = 20 x 14 = 280 m2.`
  },
  {
    id: 20,
    type: "measurement",
    ...
    correctAnswer: 1,
    explanation: `185 / 60 = 3 h remainder 5 min = 3 h 5 min.`
  },
  {
    id: 21,
    type: "measurement",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: `Area = 24 m2. Tins = 24 / 8 = 3.`
  },
  {
    id: 23,
    type: "measurement",
    question: `3 kg 200 g of bananas are divided equally into 8 bags. What is the mass of each bag?`,
    options: [
      "350 g",
      "380 g",
      "400 g",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: `Side = 13 cm. Area = 13 x 13 = 169 cm2.`
  },
  {
    id: 25,
    type: "measurement",
    ...
    correctAnswer: 2,
    explanation: `9:35 PM to midnight = 2 h 25 min. Midnight to 6:20 AM = 6 h 20 min. Total = 8 h 45 min.`
  },
  {
    id: 26,
    type: "geometry",
    ...
    correctAnswer: 2,
    explanation: `Exterior angle = 180 - 135 = 45. Sides = 360 / 45 = 8.`
  },
  {
    id: 27,
    type: "geometry",
    question: `Two angles of a quadrilateral are 85 and 110 degrees. The other two are equal. What is each?`,
    options: [
      "75 degrees",
      "80 degrees",
      "82.5 degrees",
    ...
    correctAnswer: 2,
    explanation: `Remaining = 360 - 85 - 110 = 165. Each = 165 / 2 = 82.5 degrees.`
  },
  {
    id: 28,
    type: "geometry",
    ...
    correctAnswer: 2,
    explanation: `Total parts = 6. Each part = 30. Largest = 3 x 30 = 90 degrees.`
  },
  {
    id: 29,
    type: "geometry",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: `Area = (22/7) x 7 x 7 = 22 x 7 = 154 cm2.`
  },
  {
    id: 31,
    type: "geometry",
    question: `The diagonal of a square is 10 cm. What is its area?`,
    options: [
      "25 cm2",
      "50 cm2",
      "100 cm2",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: `Co-interior angles add up to 180 degrees.`
  },
  {
    id: 33,
    type: "data",
  ...
  },
  {
    id: 36,
    type: "data",
    question: `The mean of 6 numbers is 14. Five are: 11, 18, 9, 15, 17. What is the sixth?`,
    options: [
      "12",
      "13",
      "14",
    ...
    correctAnswer: 2,
    explanation: `Total = 84. Sum of 5 = 70. Sixth = 14.`
  },
  {
    id: 37,
    type: "data",
  ...
  },
  {
    id: 38,
    type: "data",
    question: `A spinner has 12 sections: 4 red, 5 blue, 3 green. What is P(not blue)?`,
    options: [
      "5/12",
      "7/12",
      "2/3",
...
export default function NumeracyMixed8Page() {
  ...
  const availableQuestions = isPremium ? numeracyMixed8Questions : numeracyMixed8Questions.slice(0, FREE_QUESTION_LIMIT)
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="max-w-2xl mx-auto shadow-lg">
            <CardHeader className="text-center bg-blue-50 rounded-t-lg border-b">
              ...
              <CardTitle className="text-2xl text-blue-800">Numeracy Mixed 8</CardTitle>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="max-w-3xl mx-auto shadow-lg">
            <CardHeader className="text-center bg-blue-50 rounded-t-lg border-b">
              ...
              <p className="text-gray-600 mt-2">Grade 4 PEP Numeracy Mixed 8</p>
            </CardHeader>
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <CardTitle className="text-2xl text-blue-800 mt-1">Grade 4 PEP Numeracy Mixed 8 Report</CardTitle>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold">Numeracy Mixed 8</h1>
