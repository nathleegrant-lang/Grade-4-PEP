...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Mixed 9",
  "subtitle": "Grade 4 PEP Mixed Practice Task",
  "introduction": "Read the sources about road safety in Jamaica. Then complete the task parts. Some parts are direct and some require deeper thinking.",
  "difficultyLabel": "Mixed • Blended difficulty for realistic exam-style preparation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Road Safety Facts",
      "content": "Road safety is a serious concern in Jamaica. Accidents on roads can cause injury or death to drivers, passengers, and pedestrians. Common causes of road accidents include speeding, driving while using a phone, poor road conditions, and not wearing seatbelts. Following road rules helps protect everyone who uses the roads."
    },
    {
      "id": 2,
      "title": "Source 2: Staying Safe on the Roads",
      "content": "There are many things people can do to stay safe on Jamaica's roads. Pedestrians should use crossings and pavements where they are available. Drivers must follow speed limits and avoid distractions. Cyclists should wear helmets and use lights at night. Wearing a seatbelt in a vehicle can greatly reduce the risk of serious injury in an accident."
    },
    {
      "id": 3,
      "title": "Source 3: Students Promoting Road Safety",
      "content": "Some schools in Jamaica have formed road safety clubs. Students learn the rules of the road and then share what they know with younger students, family members, and the wider community. One road safety officer said that when young people become advocates for road safety, the message reaches more people. Schools that take road safety seriously help to create communities where everyone is more careful."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what is one common cause of road accidents in Jamaica?",
      "options": [
        "Walking too slowly",
        "Speeding",
      ...
      "correctAnswer": 1,
      "explanation": "Source 1 lists speeding as one of the common causes of road accidents in Jamaica.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what can wearing a seatbelt do?",
      "options": [
        "Make the car go faster",
        "Greatly reduce the risk of serious injury in an accident",
        "Replace road signs",
        "Stop accidents from happening"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 states that wearing a seatbelt can greatly reduce the risk of serious injury in an accident.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the road safety officer's comment in Source 3 suggest about young advocates?",
      "options": [
        "Students should not talk about road safety",
        "Young advocates can extend the road safety message further than traditional methods",
        "Road safety is only for adults to teach",
        "Schools cause more accidents"
      ],
      "correctAnswer": 1,
      "explanation": "The officer says young advocates reach more people, suggesting that student involvement spreads road safety messages more widely and effectively.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using the sources, explain TWO ways that people in Jamaica can be safer on the roads.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 practical ways",
        "Use source details"
      ],
      "reviewGuidance": "Include wearing seatbelts, following speed limits, using crossings, wearing helmets, avoiding phone use while driving, and using lights at night.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Road safety only matters for adults",
        "The causes of accidents in Source 1 show why education campaigns like those in Source 3 are needed",
        "Students cannot learn about road safety",
        "Speeding is not a real problem in Jamaica"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 identifies the dangerous causes of accidents; Source 3 shows how schools address those causes through education and advocacy.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why is it important for students to learn about and promote road safety? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your ideas clearly"
      ],
      "reviewGuidance": "Connect the real risks from Source 1, the practical safety actions from Source 2, and the wide community impact of student advocacy shown in Source 3.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school community newsletter about road safety in Jamaica. Explain why road safety matters, what people can do to stay safe, and how students can help spread the message.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use facts from all three sources",
        "Include a clear conclusion"
      ],
      "reviewGuidance": "Open with why road safety is a serious concern. Give practical safety advice using Source 2. End with how student advocates can carry the message further into their communities.",
      "maxScore": 12
    }
  ]
}
