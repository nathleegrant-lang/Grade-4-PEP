...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Moderate 2",
  "subtitle": "Grade 4 PEP Moderate Practice Task",
  "introduction": "Read the sources about school gardens in Jamaica. Then answer the questions. Use details from more than one source when needed.",
  "difficultyLabel": "Moderate • Standard Grade 4 PEP level with inference and evidence use",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Growing at School",
      "content": "Some schools in Jamaica have started gardens where students grow vegetables, herbs, and fruit trees. Students plant seeds, water the soil, and watch what happens over time. Teachers use the garden to explain science topics such as plant growth, weather, and soil. The garden gives students a chance to learn by doing, not just by reading."
    },
    {
      "id": 2,
      "title": "Source 2: What Gardens Teach",
      "content": "A school garden teaches students more than how to grow plants. Students learn patience because they must wait for seeds to sprout and grow. They also learn to work together when they tend the garden as a group. Garden produce is sometimes used in school meals, which teaches students where their food comes from. Schools with gardens often report that students are more interested in science."
    },
    {
      "id": 3,
      "title": "Source 3: One Student's Experience",
      "content": "Marcus had never grown anything before his school started a garden project. He was surprised to find that he enjoyed watering the plants each morning. 'At first I thought it was extra work,' he said, 'but now I look forward to checking on the tomatoes.' His teacher noted that Marcus started asking more questions in science class after the project began."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, how do teachers use the school garden?",
      "options": [
        "To punish students who misbehave",
        "To explain science topics such as plant growth and soil",
        "To replace homework with outdoor tasks",
        "To grow food only for teachers"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 says teachers use the garden to explain science topics such as plant growth, weather, and soil.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does the word 'patience' most nearly mean?",
      "options": [
        "The ability to wait calmly",
        "A type of garden tool",
        "A fast way of growing plants",
        "Excitement about new things"
      ],
      "correctAnswer": 0,
      "explanation": "In this context, patience means the ability to wait calmly, as students must wait for seeds to sprout.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "options": [
        "School gardens make students tired and uninterested",
        "School gardens can increase student curiosity and engagement with learning",
        "Gardens are only useful for growing food",
        "Science lessons are better without a garden"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 says schools with gardens often report more student interest in science; Source 3 shows Marcus asking more questions after the project started.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using Source 2, explain TWO things students learn from working in a school garden.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 lessons",
        "Use source details"
      ],
      "reviewGuidance": "Include patience while waiting for growth, teamwork, understanding where food comes from, and increased interest in science.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What can you infer about Marcus from Source 3?",
      "options": [
        "He dislikes going to school",
        "His attitude towards the project changed as he became more involved",
        "He only cared about eating the tomatoes",
        "He was already an expert gardener"
      ],
      "correctAnswer": 1,
      "explanation": "Marcus went from thinking it was extra work to looking forward to it, and began asking more science questions, showing his attitude changed through involvement.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "How do the sources suggest that school gardens benefit students in more ways than just growing food? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use information from at least 2 sources",
        "Explain clearly"
      ],
      "reviewGuidance": "Link the skills and curiosity gains from Source 2 with Marcus's growing enthusiasm and science engagement in Source 3.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school newsletter persuading students to support a school garden project. Use information from all three sources.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Explain what happens in a garden",
        "Show what students can learn",
        "Use complete sentences"
      ],
      "reviewGuidance": "Introduce the idea of a school garden, explain the learning benefits, and use examples like Marcus to show how students can grow in confidence and curiosity.",
      "maxScore": 12
    }
  ]
}
