...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Mixed 5",
  "subtitle": "Grade 4 PEP Mixed Practice Task",
  "introduction": "Read the sources about technology in education in Jamaica. Then complete the task parts. Some parts are direct and some require deeper thinking.",
  "difficultyLabel": "Mixed • Blended difficulty for realistic exam-style preparation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Technology in Schools",
      "content": "Technology is changing the way students learn in Jamaica. Many schools now use computers and tablets in classrooms. Students can access information quickly using the internet, watch educational videos, and complete interactive exercises. Technology allows teachers to present lessons in new and engaging ways."
    },
    {
      "id": 2,
      "title": "Source 2: Challenges of School Technology",
      "content": "Not all students in Jamaica have equal access to technology. Some schools in rural areas have fewer devices and slower internet connections. When the electricity goes off or equipment breaks down, lessons can be disrupted. Students who do not have devices at home may struggle to complete assignments that require technology."
    },
    {
      "id": 3,
      "title": "Source 3: Using Technology Responsibly",
      "content": "Using technology well at school requires responsibility. Students should stay focused on educational tasks and avoid distractions. One school principal explained that when students are taught to use technology as a tool for learning rather than just for entertainment, they develop skills that will help them in the future. Schools must also teach students about online safety."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, how does technology help teachers?",
      "options": [
        "It replaces teachers completely",
        "It allows teachers to present lessons in new and engaging ways",
        "It only helps with Mathematics lessons",
        "It removes the need for textbooks"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 says technology allows teachers to present lessons in new and engaging ways.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, which students may struggle the most with technology-based assignments?",
      "options": [
        "Students who live near the school",
        "Students who do not have devices at home",
        "Students who are very tall",
        "Students in science classes"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 says students who do not have devices at home may struggle to complete technology-based assignments.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the principal's comment in Source 3 suggest about technology and students' futures?",
      "options": [
        "Technology is harmful to students",
        "Only rich schools should use technology",
        "Learning to use technology as a learning tool prepares students with skills for the future",
        "Technology should only be used after school"
      ],
      "correctAnswer": 2,
      "explanation": "The principal says using technology as a learning tool develops skills that will help students in the future, suggesting long-term benefits beyond current lessons.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using the sources, explain TWO challenges that technology in schools can create.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 clear challenges",
        "Use source details"
      ],
      "reviewGuidance": "Challenges include unequal access in rural areas, power cuts disrupting lessons, students lacking home devices, and distraction from learning.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Technology has no disadvantages in schools",
        "Challenges with access make it even more important to teach responsible, focused use of technology",
        "Schools should remove all technology",
        "Students who have devices at home need no guidance"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 shows access is unequal; Source 3 shows that responsible use and proper guidance make the most of what is available.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Should schools in Jamaica continue to invest in technology for learning? Use information from at least TWO sources to support your view.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your reasoning"
      ],
      "reviewGuidance": "Acknowledge challenges from Source 2 but connect the learning benefits from Sources 1 and 3 to argue that responsible, well-planned use is worth the investment.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school magazine about the use of technology in Jamaican schools. Discuss its benefits, its challenges, and how students should use it responsibly.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use facts from all three sources",
        "Include a balanced conclusion"
      ],
      "reviewGuidance": "Open with how technology is changing learning. Describe challenges honestly. End by explaining how responsible use and proper support can help all students benefit.",
      "maxScore": 12
    }
  ]
}
