...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Mixed 10",
  "subtitle": "Grade 4 PEP Mixed Practice Task",
  "introduction": "Read the sources about sport and physical activity in Jamaica. Then complete the task parts. Some parts are direct and some require deeper thinking.",
  "difficultyLabel": "Mixed • Blended difficulty for realistic exam-style preparation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Sport in Jamaica",
      "content": "Jamaica has a proud sporting tradition. The island is world-famous for its sprinters, including Olympic gold medallists who have broken world records. Cricket, football, netball, and athletics are among the most popular sports. Sport in Jamaica brings communities together and gives young people an opportunity to develop skills, discipline, and confidence."
    },
    {
      "id": 2,
      "title": "Source 2: The Benefits of Physical Activity",
      "content": "Regular physical activity is important for health at every age. Exercise helps keep the heart healthy, builds strong muscles and bones, and can improve mood and mental wellbeing. Children who are physically active tend to sleep better and concentrate more in school. Sport also teaches important life skills such as teamwork, perseverance, and goal-setting."
    },
    {
      "id": 3,
      "title": "Source 3: Sport in Schools",
      "content": "Schools in Jamaica use physical education and sport programmes to encourage active lifestyles. Many schools take part in inter-school competitions in athletics, cricket, football, and netball. One physical education teacher said that sport gives students who may struggle in the classroom a chance to shine in a different way. Schools that invest in sport programmes often see improvements in students' overall confidence and wellbeing."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what is Jamaica world-famous for in sport?",
      "options": [
        "Cricket only",
        "Its swimmers",
        "Its sprinters, including Olympic gold medallists",
        "Its footballers"
      ],
      "correctAnswer": 2,
      "explanation": "Source 1 states that Jamaica is world-famous for its sprinters, including Olympic gold medallists who have broken world records.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what life skills can sport teach?",
      "options": [
        "Only scoring goals",
        "Cooking and crafts",
        "Teamwork, perseverance, and goal-setting",
        "Reading and writing"
      ],
      "correctAnswer": 2,
      "explanation": "Source 2 says sport teaches important life skills such as teamwork, perseverance, and goal-setting.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the physical education teacher's comment in Source 3 suggest about the value of sport?",
      "options": [
        "Sport is only for students who are already good at it",
        "Sport provides an opportunity for students to succeed who may not find success in academic work",
        "Physical education is less important than other subjects",
        "Only athletics matters in school sport"
      ],
      "correctAnswer": 1,
      "explanation": "The teacher says sport gives students who struggle in the classroom a chance to shine differently, showing sport has value beyond academic achievement.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using the sources, explain TWO benefits of physical activity or sport for students.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 clear benefits",
        "Use source details"
      ],
      "reviewGuidance": "Include health benefits such as heart health and bone strength, improved concentration and sleep, life skills like teamwork, and increased confidence and wellbeing.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Sport has no effect on how well students do in school",
        "The health and wellbeing benefits of physical activity in Source 2 support the case for school sport programmes in Source 3",
        "Sport only helps elite athletes",
        "Physical education is not important in primary schools"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 describes the health and learning benefits of exercise; Source 3 shows how school sport programmes deliver those same benefits.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why should Jamaican schools invest more in sport and physical education? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your reasoning"
      ],
      "reviewGuidance": "Connect Jamaica's sporting heritage and community pride from Source 1, the health and learning benefits from Source 2, and how school programmes build confidence from Source 3.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school magazine about the importance of sport and physical activity for students in Jamaica. Explain the benefits, how sport builds character, and why schools should support it.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use facts from all three sources",
        "Include a convincing conclusion"
      ],
      "reviewGuidance": "Open with Jamaica's sporting tradition and pride. Describe the health and character benefits. End with a strong argument for why schools must invest in sport for all students.",
      "maxScore": 12
    }
  ]
}
