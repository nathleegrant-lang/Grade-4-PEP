...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Difficult 5",
  "subtitle": "Grade 4 PEP Difficult Practice Task",
  "introduction": "Read the sources about coral reefs and conservation efforts in Jamaica. Then answer the task parts. Some questions will ask you to connect ideas across the sources.",
  "difficultyLabel": "Difficult • Closer reading, stronger inference, and deeper explanation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: What Are Coral Reefs?",
      "content": "Coral reefs are large underwater structures built by tiny animals called coral polyps. They are sometimes called the rainforests of the sea because they support thousands of different species of fish, plants, and other sea creatures. In Jamaica, coral reefs protect the coastline by reducing the strength of waves. They also attract tourists who come to snorkel and dive, which supports jobs and businesses across the island."
    },
    {
      "id": 2,
      "title": "Source 2: Threats to Jamaica's Reefs",
      "content": "Jamaica's coral reefs have suffered greatly over the past few decades. Pollution from land, including rubbish and chemicals, damages the coral. Overfishing removes too many fish, disrupting the balance of life on the reef. Rising ocean temperatures caused by climate change cause a process known as coral bleaching, where corals lose their colour and may die. Without protection, large areas of reef can be lost in a short time."
    },
    {
      "id": 3,
      "title": "Source 3: Youth Groups Restore the Reef",
      "content": "In several coastal communities in Jamaica, youth groups have joined reef restoration projects. Students help to grow small pieces of coral in underwater nurseries and then attach them to damaged reef areas. One young participant said, 'I did not know I could actually help fix a reef. Now I want to study marine science.' These projects show that with training, young people can make real contributions to conservation."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, how do coral reefs benefit Jamaica's economy?",
      "options": [
        "They provide fresh water for farming",
        "They attract tourists, supporting jobs and businesses",
        "They are used to build roads along the coast",
        "They replace electricity during storms"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 states that coral reefs attract tourists who come to snorkel and dive, supporting jobs and businesses.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does 'coral bleaching' describe?",
      "options": [
        "A process where coral grows faster",
        "When corals are cleaned by divers",
        "When rising temperatures cause coral to lose colour and potentially die",
        "A type of fishing practice"
      ],
      "correctAnswer": 2,
      "explanation": "Source 2 explains that rising ocean temperatures cause coral bleaching, where corals lose colour and may die.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the young participant's comment in Source 3 suggest about the impact of hands-on learning?",
      "options": [
        "Students should only learn about reefs in classrooms",
        "Real involvement in conservation can change a student's ambitions and sense of possibility",
        "Youth groups are only useful for adults to supervise",
        "Marine science is too difficult for school students"
      ],
      "correctAnswer": 1,
      "explanation": "The student's comment shows how direct involvement changed their view of what they could achieve and what they wanted to study.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Explain TWO threats to Jamaica's coral reefs and what could happen if these threats are not addressed.",
      "guidelines": [
        "Write 2–3 complete sentences",
        "Identify 2 threats clearly",
        "Explain a consequence for each"
      ],
      "reviewGuidance": "Mention pollution, overfishing, and coral bleaching, and explain how each leads to reef damage or loss of marine life.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Coral reefs are too deep to be affected by pollution",
        "The many benefits of reefs described in Source 1 are put at risk by the threats in Source 2",
        "Coral bleaching helps tourists see more colourful reefs",
        "Jamaica does not have coral reefs near its coast"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 shows what reefs offer; Source 2 shows how those benefits are under threat.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why is it important for young people to take part in coral reef conservation? Use information from at least TWO sources to support your answer.",
      "guidelines": [
        "Write 3–4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your thinking clearly"
      ],
      "reviewGuidance": "Connect the importance of reefs (jobs, coastline, biodiversity) with how young people can restore damaged areas and inspire others.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a report for your school's environmental club explaining what coral reefs are, the threats they face, and how students can help protect them. Use all three sources in your response.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use information from all 3 sources",
        "Explain ideas fully, not just list facts",
        "Write in complete sentences"
      ],
      "reviewGuidance": "Introduce what reefs are and why they matter. Describe the threats clearly. End with concrete actions students can take, based on examples from the sources.",
      "maxScore": 12
    }
  ]
}
