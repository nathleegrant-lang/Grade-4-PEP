...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Mixed 8",
  "subtitle": "Grade 4 PEP Mixed Practice Task",
  "introduction": "Read the sources about respecting elders and community wisdom in Jamaica. Then complete the task parts. Some parts are direct and some require deeper thinking.",
  "difficultyLabel": "Mixed • Blended difficulty for realistic exam-style preparation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: The Value of Elders",
      "content": "In Jamaican culture, older members of the community are respected for their experience and wisdom. Elders have lived through many different times and have knowledge that cannot always be found in books. They can share stories, advice, and skills that help younger generations understand their history and identity. Respecting elders is seen as an important part of good character in Jamaican society."
    },
    {
      "id": 2,
      "title": "Source 2: Passing on Knowledge",
      "content": "Knowledge passes from one generation to the next through conversation, stories, and shared activities. Grandparents often teach grandchildren how to cook traditional meals, grow food, or make crafts. Some skills, such as weaving baskets or making certain foods, might be lost if younger people do not learn them from elders. Communities that value this exchange of knowledge tend to preserve their culture more effectively."
    },
    {
      "id": 3,
      "title": "Source 3: Connecting Generations at School",
      "content": "Some schools in Jamaica have introduced programmes where elder community members visit classrooms to share their stories and skills. Students have learned folk songs, traditional crafts, and historical accounts that are not written in school textbooks. One student said, 'My grandmother knows things that I never would have found in a book.' These programmes build understanding between generations and help students appreciate their roots."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, why are elders respected in Jamaican culture?",
      "options": [
        "Because they are the wealthiest members of society",
        "Because of their experience, wisdom, and knowledge of history",
        "Because they own the most land",
        "Because they run all schools"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 says elders are respected for their experience and wisdom, and for their knowledge that helps younger generations understand their history and identity.",
      "maxScore": 2
    },
    {
      "id": 2,
      "title": "Part B: Direct Information",
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what might happen if younger people do not learn traditional skills from elders?",
      "options": [
        "Communities would become richer",
        "Those skills could be lost",
        "Schools would improve faster",
        "Families would stop cooking"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 states that some skills might be lost if younger people do not learn them from elders.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the student's comment in Source 3 suggest about traditional knowledge?",
      "options": [
        "Textbooks contain all important knowledge",
        "Grandmothers do not know useful things",
        "Some knowledge exists only in people's lived experience and cannot be found in books",
        "Schools should replace grandparents"
      ],
      "correctAnswer": 2,
      "explanation": "The student's comment shows that some knowledge lives only in the experience of elders and is not written down, making personal connection important.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using the sources, explain TWO reasons why it is important to learn from elders in Jamaica.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 clear reasons",
        "Use source details"
      ],
      "reviewGuidance": "Include reasons such as learning skills and traditions that could be lost, understanding cultural identity and history, and gaining wisdom not found in textbooks.",
      "maxScore": 4
    },
    {
      "id": 5,
      "title": "Part E: Making Connections",
      "category": "reading",
      "type": "multiple-choice",
      "question": "Which statement best connects Source 2 and Source 3?",
      "options": [
        "Traditional skills are no longer relevant",
        "School programmes that bring elders in help prevent the loss of knowledge described in Source 2",
        "Grandparents do not belong in classrooms",
        "Schools already teach all traditional skills"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 shows the risk of traditional knowledge being lost; Source 3 shows how school programmes actively work to prevent that loss.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why should schools create more opportunities for students to learn from elders in their communities? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your ideas clearly"
      ],
      "reviewGuidance": "Link the value of elders' knowledge from Source 1 and the risk of losing traditional skills from Source 2 to the intergenerational learning shown in Source 3.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school magazine explaining why it is important to respect and learn from elders, what knowledge they carry, and how schools can help connect generations.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use facts from all three sources",
        "Include a thoughtful conclusion"
      ],
      "reviewGuidance": "Begin with why elders are respected and what they know. Explain the risk of losing traditional knowledge. End with how school programmes can bridge generations and benefit students.",
      "maxScore": 12
    }
  ]
}
