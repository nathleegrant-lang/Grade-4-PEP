...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Moderate 10",
  "subtitle": "Grade 4 PEP Moderate Practice Task",
  "introduction": "Read the sources about reading and imagination. Then answer the questions. Use details from more than one source when needed.",
  "difficultyLabel": "Moderate • Standard Grade 4 PEP level with inference and evidence use",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: The Power of Reading",
      "content": "Reading is one of the most important skills a person can develop. Books open doors to new worlds, ideas, and ways of thinking. Reading regularly builds vocabulary, improves writing, and strengthens concentration. Students who read widely often find it easier to understand new topics in all subjects. Jamaica's national reading programme encourages children to read at least fifteen minutes every day."
    },
    {
      "id": 2,
      "title": "Source 2: Imagination and Learning",
      "content": "When students read fiction, their imagination is put to work. They picture characters, places, and events in their minds. This imaginative activity strengthens the brain's ability to understand different points of view and to think creatively. Research suggests that students who read fiction regularly develop greater empathy, which helps them understand and relate to others. Stories also provide a safe way for children to explore emotions and difficult situations."
    },
    {
      "id": 3,
      "title": "Source 3: A Changed Reader",
      "content": "Jamal disliked reading for most of his primary school years. A teacher gave him a book about a young boy in Jamaica who discovers a hidden cave near the sea. Jamal finished it in three days. 'I could not put it down,' he said. 'For the first time, I felt like the story was about someone like me.' He has since read four more books and says reading now feels like an adventure."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what does Jamaica's national reading programme encourage?",
      "options": [
        "Children to read at least one hour a day",
        "Children to read at least fifteen minutes every day",
        "Children to only read non-fiction books",
        "Children to read only during school hours"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 states that the national reading programme encourages children to read at least fifteen minutes every day.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does 'empathy' most nearly mean?",
      "options": [
        "The ability to run very fast",
        "Understanding and sharing the feelings of others",
        "A type of imaginative exercise",
        "A skill needed for Mathematics"
      ],
      "correctAnswer": 1,
      "explanation": "Empathy means the ability to understand and share the feelings of other people, which is how it is used when describing what fiction reading develops.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "options": [
        "Children should only read books about history",
        "Stories that connect with readers personally can change their relationship with reading",
        "Reading fiction is less important than reading facts",
        "Imagination plays no role in learning"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 explains how imagination and connection through stories builds understanding; Source 3 shows Jamal connecting personally with a story, which transformed his attitude to reading.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using Source 2, explain TWO ways that reading fiction benefits students.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 benefits",
        "Use source details"
      ],
      "reviewGuidance": "Include imaginative thinking, understanding different points of view, developing empathy, and using stories to explore emotions and difficult situations.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What can you infer from Jamal's comment in Source 3?",
      "options": [
        "Jamal had always loved reading but was shy about it",
        "Finding a story that reflects your own experience can make reading feel personal and motivating",
        "Jamal only reads books about caves",
        "All students need the same book to enjoy reading"
      ],
      "correctAnswer": 1,
      "explanation": "Jamal says he felt the story was about someone like him, inferring that personal relevance and connection to a character were what changed his attitude to reading.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "How do the sources together show that reading is valuable for students in Jamaica? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use information from at least 2 sources",
        "Explain clearly"
      ],
      "reviewGuidance": "Connect the broad benefits of reading from Sources 1 and 2 with Jamal's personal transformation in Source 3 to show how reading improves both skills and engagement.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school newsletter about why reading is important and how students can develop a love of reading. Use information from all three sources.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Explain the benefits of reading",
        "Show how imagination and personal connection matter",
        "Use complete sentences"
      ],
      "reviewGuidance": "Introduce the importance of reading and its benefits. Explain how fiction builds imagination and empathy. End with how students can find books that connect with them, using Jamal's story as inspiration.",
      "maxScore": 12
    }
  ]
}
