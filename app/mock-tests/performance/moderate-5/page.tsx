...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Moderate 5",
  "subtitle": "Grade 4 PEP Moderate Practice Task",
  "introduction": "Read the sources about Jamaican folk tales and storytelling. Then answer the questions. Use details from more than one source when needed.",
  "difficultyLabel": "Moderate • Standard Grade 4 PEP level with inference and evidence use",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: What Are Folk Tales?",
      "content": "Folk tales are traditional stories passed down through generations. In Jamaica, Anansi the spider is one of the most famous folk tale characters. Anansi is known for being clever and often tricks stronger animals to get what he wants. These stories were first brought to Jamaica from West Africa and have become part of Jamaican culture and identity."
    },
    {
      "id": 2,
      "title": "Source 2: Why Folk Tales Matter",
      "content": "Folk tales do more than entertain. They often teach lessons about honesty, cleverness, and the consequences of greed. In Jamaican communities, stories were traditionally told in the evenings, helping families and neighbours come together. The storytelling tradition helps keep cultural values and history alive across generations."
    },
    {
      "id": 3,
      "title": "Source 3: Keeping Stories Alive",
      "content": "A primary school in Portland has started a folk tale club where students perform Anansi stories for parents and younger classes. One student said, 'I never heard these stories until we started the club. Now I tell them to my little brother at home.' The teacher explained that performing the stories helped students become more confident speakers and better understand their cultural roots."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, where did Anansi stories originally come from?",
      "options": [
        "England",
        "India",
        "West Africa",
      ...
      "correctAnswer": 2,
      "explanation": "Source 1 states that Anansi stories were first brought to Jamaica from West Africa.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does 'consequences' most nearly mean?",
      "options": [
        "Rewards that come before an action",
        "Results that follow from actions or choices",
        "A type of folk tale character",
        "A style of storytelling"
      ],
      "correctAnswer": 1,
      "explanation": "Consequences means results or outcomes that follow from actions or choices, as used in the context of teaching lessons about greed.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "options": [
        "Folk tales are only useful for young children",
        "Storytelling can bring people together and strengthen cultural identity",
        "Anansi stories should only be told at school",
        "Folk tales have no real lessons for modern life"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 says storytelling brings communities together and keeps cultural values alive; Source 3 shows students sharing stories at home and school, building cultural connection.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using Source 2, explain TWO reasons why folk tales are important in Jamaican culture.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 reasons",
        "Use source details"
      ],
      "reviewGuidance": "Include teaching lessons about values, bringing families and neighbours together, and keeping cultural history and values alive across generations.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "The student had always loved folk tales",
        "Folk tale knowledge can be passed on informally from student to younger family members",
        "The school club replaced all other lessons",
        "Anansi stories are not popular with younger children"
      ],
      "correctAnswer": 1,
      "explanation": "The student is now telling stories to their little brother at home, showing that school learning can spread cultural knowledge beyond the classroom.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "How do the sources show that folk tales are still relevant and valuable to students today? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use information from at least 2 sources",
        "Explain clearly"
      ],
      "reviewGuidance": "Connect the cultural and moral lessons from Source 2 with the confidence, cultural understanding, and informal sharing shown in Source 3.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school magazine about Jamaican folk tales and why students should learn about them. Use information from all three sources.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Introduce what folk tales are",
        "Explain their value and how schools can keep them alive",
        "Use complete sentences"
      ],
      "reviewGuidance": "Introduce Anansi and folk tales, explain their cultural and educational importance, and use the school club example to show how students can continue this tradition.",
      "maxScore": 12
    }
  ]
}
