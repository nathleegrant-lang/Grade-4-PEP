...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Difficult 6",
  "subtitle": "Grade 4 PEP Difficult Practice Task",
  "introduction": "Read the sources about water and conservation in Jamaica. Then answer the task parts. Some questions will ask you to think carefully about what the sources suggest.",
  "difficultyLabel": "Difficult • Closer reading, stronger inference, and deeper explanation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Why Water Is Precious",
      "content": "Water is essential for all living things. People use water for drinking, cooking, cleaning, and growing food. Jamaica receives rainfall throughout the year, but the amount varies across the island. Some areas in the south and east receive much less rain than the Blue Mountains region. In dry periods, some communities face water shortages. Rivers, springs, and underground water sources must be managed carefully to ensure enough water for everyone."
    },
    {
      "id": 2,
      "title": "Source 2: Challenges Facing Jamaica's Water Supply",
      "content": "One major challenge is that much of the water in Jamaica's supply system is lost before it reaches homes. Old pipes can leak, and illegal connections waste large amounts of treated water. Climate change is also making dry seasons longer and more intense. Deforestation worsens the problem because trees help to capture and store rainfall in the soil. Without trees, rainwater runs off quickly into the sea rather than soaking into the ground."
    },
    {
      "id": 3,
      "title": "Source 3: Schools Take the Lead",
      "content": "Some schools in Jamaica have started programmes to help students use water wisely. Students collect rainwater in tanks for watering school gardens. They check taps and report leaks promptly. One principal said, 'The habits students build in school carry into their homes and communities.' Water conservation education teaches students that small daily choices can make a big difference to a shared resource."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, which part of Jamaica receives less rainfall?",
      "options": [
      ...
      "correctAnswer": 2,
      "explanation": "Source 1 states that some areas in the south and east receive much less rain than the Blue Mountains region.",
      "maxScore": 2
    },
    {
      "id": 2,
      "title": "Part B: Understanding a Cause",
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, why does deforestation make water shortages worse?",
      "options": [
        "Trees block pipelines and cause flooding",
        "Without trees, rainwater runs off quickly instead of soaking into the ground",
        "Deforestation makes rivers run faster",
        "Trees cause dry seasons to become longer"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 explains that trees help capture rainfall in the soil, so without trees water runs off into the sea.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the principal's comment in Source 3 suggest about school-based conservation?",
      "options": [
        "Conservation habits learned at school are too simple to make a difference",
        "Schools are the only places where conservation is practised",
        "Habits formed at school can spread to homes and communities",
        "Students cannot understand water conservation until they are adults"
      ],
      "correctAnswer": 2,
      "explanation": "The principal explains that habits built at school carry into homes and communities, showing wider impact.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Explain TWO reasons why Jamaica's water supply faces challenges, based on the sources.",
      "guidelines": [
        "Write 2–3 complete sentences",
        "Give 2 clear challenges",
        "Use details from the sources"
      ],
      "reviewGuidance": "Consider leaking pipes, illegal connections, climate change effects on dry seasons, and the role of deforestation.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Old pipes are the only cause of water shortages in Jamaica",
        "The problems described in Source 2 make the student actions in Source 3 more important",
        "Schools cannot help with national water supply issues",
        "Rainwater tanks are not useful in Jamaica"
      ],
      "correctAnswer": 1,
      "explanation": "The challenges in Source 2 show why the water-saving habits and actions in Source 3 are genuinely needed.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why should students learn about water conservation? Use information from at least TWO sources to support your answer.",
      "guidelines": [
        "Write 3–4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your reasoning"
      ],
      "reviewGuidance": "Link the real challenges facing Jamaica's water supply to how student habits and school programmes can reduce waste and build awareness.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for a community newsletter explaining why water is precious, what threatens Jamaica's water supply, and how students can help conserve water. Use all three sources in your response.",
      "guidelines": [
      ...
      "reviewGuidance": "Open with why water matters to all life and communities. Discuss the real challenges. Close with practical steps students can take, using the school examples from Source 3.",
      "maxScore": 12
    }
  ]
}
