...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Easy 9",
  "subtitle": "Grade 4 PEP Easy Practice Task",
  "introduction": "Read the sources about weather and seasons in Jamaica. Then answer the questions that follow. Use the information from the sources to help you.",
  "difficultyLabel": "Easy • Clear facts, direct evidence, and simpler writing support",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Jamaica's Weather",
      "content": "Jamaica has a warm and sunny climate all year round. The temperature is usually between 25 and 32 degrees Celsius. Jamaica does not have four seasons like some countries. Instead, Jamaica has a dry season and a wet season. The dry season is from December to April. The wet season is from May to November."
    },
    {
      "id": 2,
      "title": "Source 2: The Wet Season",
      "content": "During the wet season, Jamaica gets a lot of rainfall. The rain helps crops to grow and fills rivers and reservoirs with water. Heavy rain can sometimes cause flooding in low areas. Jamaica can also be affected by hurricanes during the wet season. People prepare for heavy rain by storing food and water and listening to weather reports."
    },
    {
      "id": 3,
      "title": "Source 3: How Weather Affects Daily Life",
      "content": "The weather affects what people do every day in Jamaica. On sunny days, people enjoy outdoor activities like sports and visiting the beach. Farmers depend on rain to water their crops. When heavy rains come, schools sometimes close for safety. Understanding the weather helps communities plan and stay safe."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, when is the dry season in Jamaica?",
      "options": [
        "May to November",
        "January to June",
        "December to April",
      ...
      "correctAnswer": 2,
      "explanation": "Source 1 states that the dry season in Jamaica is from December to April.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what is one good thing the wet season rain does?",
      "options": [
        "It causes schools to close",
        "It helps crops to grow",
        "It stops hurricanes",
        "It makes rivers dry up"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 says the rain helps crops to grow and fills rivers and reservoirs.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What do Sources 2 and 3 both tell us about heavy rain?",
      "options": [
        "Heavy rain is always helpful to farmers",
        "Heavy rain only affects the mountains",
        "Heavy rain can cause problems for communities",
        "Heavy rain is rare in Jamaica"
      ],
      "correctAnswer": 2,
      "explanation": "Source 2 mentions flooding and hurricanes; Source 3 says schools sometimes close and people must plan carefully when heavy rains come.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Give TWO facts about Jamaica's weather or seasons from the sources. Write in complete sentences.",
      "guidelines": [
        "Write 2 complete sentences",
        "Give 2 correct facts",
        "Use your own words"
      ],
      "reviewGuidance": "Choose two clear facts, such as the temperature range, the names of the seasons, how rain helps crops, or how weather affects daily life.",
      "maxScore": 4,
    ...
    },
    {
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "Why is it important to understand the weather in Jamaica?",
      "options": [
        "So people know what to wear to parties",
        "So communities can plan and stay safe",
        "So the government can change the seasons",
        "So hurricanes happen less often"
      ],
      "correctAnswer": 1,
      "explanation": "Source 3 says understanding the weather helps communities plan and stay safe.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Explain how the weather affects the lives of people in Jamaica.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Use information from the sources"
      ],
      "reviewGuidance": "Mention sunny weather for outdoor activities, rain helping farmers, flooding risks, and school closures during heavy rains.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a short article for your class booklet about weather and seasons in Jamaica. Tell what the seasons are, how the wet season affects life, and how weather changes what people do.",
      "guidelines": [
        "Write at least 2 paragraphs",
        "Use facts from the sources",
        "Write in complete sentences"
      ],
      "reviewGuidance": "Start by explaining Jamaica's climate and two seasons. Describe what happens during the wet season. End by explaining how weather shapes everyday life for Jamaicans.",
      "maxScore": 12
    }
  ]
}
