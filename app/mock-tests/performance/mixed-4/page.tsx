...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Mixed 4",
  "subtitle": "Grade 4 PEP Mixed Practice Task",
  "introduction": "Read the sources about food safety and healthy eating in Jamaica. Then complete the task parts. Some parts are direct and some require deeper thinking.",
  "difficultyLabel": "Mixed • Blended difficulty for realistic exam-style preparation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Choosing Healthy Foods",
      "content": "Eating well is important for staying healthy and having energy. A balanced meal includes foods from different groups: fruits and vegetables, grains, proteins, and dairy. In Jamaica, many traditional foods such as yam, breadfruit, callaloo, and fish are nutritious and affordable. Choosing local foods helps families eat well without spending too much."
    },
    {
      "id": 2,
      "title": "Source 2: Food Safety at Home",
      "content": "Keeping food safe is just as important as choosing healthy food. Food should be stored correctly to prevent it from going bad or causing illness. Raw meat should be kept separate from other foods. Hands should be washed before and after handling food. Food that smells bad, looks strange, or is past its date should not be eaten."
    },
    {
      "id": 3,
      "title": "Source 3: Healthy Eating at School",
      "content": "Schools in Jamaica are working to improve what students eat during the school day. Some schools have tuck shops that sell healthier options such as fruits, nuts, and water instead of only sweet drinks and snacks. One nutrition teacher said that students who eat better tend to concentrate more in class and have more energy for learning and sport."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, which of the following is mentioned as a nutritious Jamaican food?",
      "options": [
        "Pizza",
        "Callaloo",
        "Chocolate cake",
      ...
      "correctAnswer": 1,
      "explanation": "Source 1 lists callaloo among nutritious and affordable Jamaican traditional foods.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what should you do before and after handling food?",
      "options": [
        "Put on gloves",
        "Wash your hands",
        "Freeze all food",
      ...
      "correctAnswer": 1,
      "explanation": "Source 2 says hands should be washed before and after handling food.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the nutrition teacher's comment in Source 3 suggest about the link between eating and learning?",
      "options": [
        "Food has no effect on school performance",
        "Students do not care what they eat at school",
        "Eating better can improve concentration and energy for school",
        "Only sport requires good nutrition"
      ],
      "correctAnswer": 2,
      "explanation": "The teacher's comment links better eating to greater concentration and energy in class, showing a direct connection between nutrition and learning.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using the sources, explain TWO ways that students can eat more healthily at school or at home.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 practical ways",
        "Use source details"
      ],
      "reviewGuidance": "Ideas include choosing local Jamaican foods, following food safety practices, selecting healthier tuck shop options, eating more fruits and vegetables.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "Only expensive foods are healthy",
        "Healthy eating choices, whether local foods or school options, support students' wellbeing",
        "Food safety is more important than healthy eating",
        "Tuck shops cannot offer healthy food"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 shows that healthy foods can be affordable and local; Source 3 shows how schools can provide those healthier options for students.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why is it important for students to understand healthy eating and food safety? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your ideas clearly"
      ],
      "reviewGuidance": "Connect how food choices affect health, energy, and learning from Sources 1 and 3, and how food safety from Source 2 prevents illness.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a guide for your school's health noticeboard explaining how to eat healthily, how to handle food safely, and how good nutrition helps students at school.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use facts from all three sources",
        "Give practical advice"
      ],
      "reviewGuidance": "Open with why healthy eating matters. Explain food safety rules clearly. End with how better nutrition supports school performance and wellbeing.",
      "maxScore": 12
    }
  ]
}
