...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Easy 1",
  "subtitle": "Grade 4 PEP Easy Practice Task",
  "difficultyLabel": "Easy • Clear facts, direct evidence, and simpler writing support",
  "introduction": "Read the sources about Jamaica's doctor bird. Then answer the questions that follow. Use the information from the sources to help you.",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Jamaica's Doctor Bird",
      "content": "The doctor bird is Jamaica's national bird. It is also called the swallow-tail hummingbird. The bird is small, but it has a long tail. The male doctor bird has bright green feathers and a red bill. Doctor birds drink nectar from flowers. They move quickly from flower to flower during the day."
    },
    {
      "id": 2,
      "title": "Source 2: Where the Doctor Bird Lives",
      "content": "Doctor birds live in many parts of Jamaica. They can be found in gardens, forests, and mountain areas. They like places where flowers grow. These birds help plants because they carry pollen from one flower to another. Many Jamaicans feel proud when they see the doctor bird."
    },
    {
      "id": 3,
      "title": "Source 3: Why the Doctor Bird is Special",
      "content": "The doctor bird is special because it is one of Jamaica's national symbols. It appears in books, lessons, and pictures about Jamaica. The bird can fly forward, backward, and stay in one place in the air. People enjoy watching it because it is fast and beautiful."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what does the doctor bird drink?",
      "options": [
        "Rain water",
        "Nectar from flowers",
        "Coconut water",
      ...
      "correctAnswer": 1,
      "explanation": "Source 1 says that doctor birds drink nectar from flowers.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, where can the doctor bird be found?",
      "options": [
        "Only at the beach",
        "Only in caves",
        "In gardens, forests, and mountains",
        "Only near rivers"
      ],
      "correctAnswer": 2,
      "explanation": "Source 2 lists gardens, forests, and mountain areas as places where the bird lives.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "Which statement is true in both Source 1 and Source 3?",
      "options": [
        "The bird is large and slow",
        "The bird is special to Jamaica",
        "The bird only comes out at night",
        "The bird lives only in one parish"
      ],
      "correctAnswer": 1,
      "explanation": "Both sources show that the doctor bird is an important and special bird in Jamaica.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Give TWO facts about the doctor bird from the sources. Write in complete sentences.",
      ...
      "reviewGuidance": "Choose two clear facts, such as what the bird drinks, where it lives, or why it is special to Jamaica.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "Why do many Jamaicans feel proud of the doctor bird?",
      "options": [
        "It is very large",
      ...
      "correctAnswer": 1,
      "explanation": "The sources explain that the doctor bird is a national symbol of Jamaica.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Explain one way the doctor bird helps plants.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Use information from the sources"
      ],
      "reviewGuidance": "Explain that the bird carries pollen from one flower to another, which helps flowers and plants grow.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a short article for your class booklet about the doctor bird. Tell what it is, where it lives, and why it is special to Jamaica.",
      "guidelines": [
        "Write at least 2 paragraphs",
        "Use facts from the sources",
        "Write in complete sentences"
      ],
      "reviewGuidance": "Introduce the doctor bird, describe where it lives or what it does, and explain why it is important to Jamaica.",
      "maxScore": 12
    }
  ]
}
              ...
              <div className="text-center space-y-6">
                ...
                <div className="rounded-xl border border-amber-200 bg-amber-50 p-5 text-left">
                  ...
                  <p className="text-sm text-slate-700">
                    This easy performance task report includes section summaries, multiple-choice results, written responses, and teacher-style guidance. Then print or save the report as a PDF with the logo.
                  </p>
                </div>
