...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Moderate 9",
  "subtitle": "Grade 4 PEP Moderate Practice Task",
  "introduction": "Read the sources about sport and teamwork in Jamaica. Then answer the questions. Use details from more than one source when needed.",
  "difficultyLabel": "Moderate • Standard Grade 4 PEP level with inference and evidence use",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Sport in Jamaican Schools",
      "content": "Sport is a major part of school life in Jamaica. Most schools compete in athletics, football, cricket, and netball. Inter-school competitions such as Boys' and Girls' Championships attract large crowds and inspire students across the island. Sport gives students an opportunity to develop discipline, set goals, and represent their school with pride."
    },
    {
      "id": 2,
      "title": "Source 2: What Teamwork Teaches",
      "content": "Playing team sports requires much more than physical ability. Athletes must communicate clearly, trust their teammates, and put the team's success above personal glory. When a team loses, players learn to recover and try again. These lessons in resilience, communication, and shared responsibility are useful both on and off the field. Coaches often say that the habits built in sport carry into students' school work and daily lives."
    },
    {
      "id": 3,
      "title": "Source 3: A Team's Story",
      "content": "The netball team at a primary school in Clarendon had lost five matches in a row. Their coach encouraged them to focus on communication and effort rather than results. After weeks of practice, they won their next two games. 'We started really talking to each other on the court,' said one player. 'That was the difference.' The team went on to reach the parish finals."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what opportunities does sport give students?",
      "options": [
        "A chance to skip lessons and play all day",
        "An opportunity to develop discipline, set goals, and represent their school",
        "A way to avoid studying for exams",
        "Only a chance to win prizes"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 says sport gives students an opportunity to develop discipline, set goals, and represent their school with pride.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does 'resilience' most nearly mean?",
      "options": [
        "A type of athletic training",
        "The ability to recover and keep going after difficulty",
        "Winning every competition",
        "A team's speed on the field"
      ],
      "correctAnswer": 1,
      "explanation": "Resilience means the ability to recover from setbacks and keep trying, which is how it is used in the context of teams that lose and try again.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "options": [
        "Winning is the only goal worth pursuing in sport",
        "Communication and teamwork can make a bigger difference than individual talent",
        "Sport only teaches physical skills",
        "Teams that lose should stop competing"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 explains that communication and putting the team first are essential; Source 3 shows how improved communication turned the netball team's results around.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using Source 2, explain TWO lessons that students can learn from playing team sports.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 lessons",
        "Use source details"
      ],
      "reviewGuidance": "Include communication, trusting teammates, putting team above self, resilience after losing, and how these habits carry into school and daily life.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What can you infer from the netball player's comment in Source 3?",
      "options": [
        "The team's improvement was mainly due to getting fitter",
        "Better communication on the court was the key change that improved results",
        "The coach played in the games",
        "The team only improved because they had new players"
      ],
      "correctAnswer": 0,
      "explanation": "The player directly links their improvement to talking to each other on the court, inferring that communication was the key factor in their success.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "How do the sources show that sport teaches students skills that go beyond the game? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use information from at least 2 sources",
        "Explain clearly"
      ],
      "reviewGuidance": "Link the broader life skills from Source 2 (resilience, communication, shared responsibility) with the team's real growth in Source 3 showing these lessons in action.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school sports magazine about why sport is valuable for students. Use information from all three sources to explain what students gain from sport beyond winning.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Explain sport's role in schools",
        "Show what teamwork teaches",
        "Use a real example like Source 3"
      ],
      "reviewGuidance": "Introduce sport's role in Jamaican school life. Explain the teamwork and life skills it builds. Use the netball team's story to illustrate how these lessons play out in practice.",
      "maxScore": 12
    }
  ]
}
