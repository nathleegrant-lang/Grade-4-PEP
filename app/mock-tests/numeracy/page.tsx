...
const numeracyLevels = [
  {
    title: "Easy",
    description: ["Direct recall and simple procedures", "Clear number skills", "Shorter word problems"],
    hrefBase: "/mock-tests/numeracy/easy",
  ...
  {
    title: "Moderate",
    description: ["Standard Grade 4 PEP level", "Multi-step thinking", "Balanced skill practice"],
    hrefBase: "/mock-tests/numeracy/moderate",
  ...
  {
    title: "Difficult",
    description: ["More reasoning-based questions", "Stronger distractors", "Closer problem solving"],
    hrefBase: "/mock-tests/numeracy/difficult",
  ...
  {
    title: "Mixed",
    description: ["Easy, moderate, and difficult blend", "Exam-style balance", "Best for full simulation"],
    hrefBase: "/mock-tests/numeracy/mixed",
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="max-w-4xl mx-auto text-center mb-10">
          ...
          <p className="text-lg text-slate-600">
            Select the level that matches your child&apos;s readiness, then choose a test number.
          </p>
        </div>
