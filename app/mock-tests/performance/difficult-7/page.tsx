...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Difficult 7",
  "subtitle": "Grade 4 PEP Difficult Practice Task",
  "introduction": "Read the sources about farming in Jamaica. Then answer the task parts. Some questions will ask you to connect ideas and think carefully about what the sources suggest.",
  "difficultyLabel": "Difficult • Closer reading, stronger inference, and deeper explanation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Jamaica's Farming Traditions",
      "content": "Farming has been at the heart of Jamaican life for centuries. Crops such as yam, banana, breadfruit, sugar cane, and coffee have shaped the island's history, culture, and economy. Small farmers, known as smallholders, grow much of the food that feeds Jamaican families. The practice of growing a mix of different crops on the same plot of land, called intercropping, has helped farmers manage pests and keep soil healthy for generations."
    },
    {
      "id": 2,
      "title": "Source 2: Challenges Facing Farmers Today",
      "content": "Jamaican farmers face many pressures. Unpredictable weather caused by climate change can damage crops and reduce harvests. Some young people are leaving rural areas to find work in towns and cities, so there are fewer people available to work on farms. Imported foods sometimes cost less than locally grown produce, making it harder for farmers to earn a fair income. If these challenges are not addressed, Jamaica's food security could be at risk."
    },
    {
      "id": 3,
      "title": "Source 3: Young Farmers of Tomorrow",
      "content": "Across Jamaica, schools with agricultural programmes are introducing students to farming skills. Students learn to plant, tend, and harvest crops. They also study soil science and learn about organic farming methods that reduce the need for chemicals. One student who participated in a school farm project said, 'I thought farming was old-fashioned, but now I see it as a real career.' These programmes aim to inspire the next generation to value and continue Jamaica's farming traditions."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what is 'intercropping'?",
      "options": [
        "Growing one crop at a time in separate fields",
        "Growing a mix of different crops on the same plot of land",
        "Importing crops from other islands",
        "A method used only for growing sugar cane"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 defines intercropping as growing a mix of different crops on the same plot of land.",
      "maxScore": 2
    },
    {
      "id": 2,
      "title": "Part B: Understanding a Challenge",
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, which of the following is NOT listed as a challenge facing Jamaican farmers?",
      "options": [
        "Unpredictable weather from climate change",
        "Young people leaving rural areas",
        "A shortage of different crop varieties",
        "Imported foods costing less than local produce"
      ],
      "correctAnswer": 2,
      "explanation": "Source 2 mentions weather, young people leaving, and cheaper imports as challenges, but not a shortage of crop varieties.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the student's comment in Source 3 suggest about attitudes towards farming?",
      "options": [
        "All students already think farming is a good career",
        "Some students start with a negative view of farming that can change through experience",
        "Farming schools are not popular in Jamaica",
        "Organic farming is too expensive for schools"
      ],
      "correctAnswer": 1,
      "explanation": "The student admits they thought farming was old-fashioned, showing that attitudes can shift when students engage directly with the work.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Explain TWO challenges that Jamaican farmers face today and why these challenges matter.",
      "guidelines": [
        "Write 2–3 complete sentences",
        "Name and explain 2 challenges",
        "Use details from the sources"
      ],
      "reviewGuidance": "Think about climate change, young people leaving farms, imported food competition, and how these affect food security and farmers' livelihoods.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "School farms have no connection to the challenges farmers face",
        "The challenges in Source 2 show why inspiring young people to value farming, as Source 3 describes, is important",
        "All problems facing farmers will disappear if students study science",
        "Source 3 shows that farming is no longer relevant to Jamaica"
      ],
      "correctAnswer": 1,
      "explanation": "The challenges in Source 2, including fewer young farmers, connect directly to why school programmes in Source 3 are needed.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why is it important to encourage young Jamaicans to learn about and value farming? Use information from at least TWO sources to support your answer.",
      "guidelines": [
        "Write 3–4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your reasoning"
      ],
      "reviewGuidance": "Connect Jamaica's farming heritage and food security with the need to inspire the next generation, as described in the school programmes.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a persuasive essay for your school newspaper encouraging students to appreciate Jamaica's farming traditions and consider careers in agriculture. Use all three sources in your response.",
      "guidelines": [
      ...
      "reviewGuidance": "Open by explaining what farming means to Jamaica. Describe the challenges and why they matter. End by making a strong case for why young people should value and support farming.",
      "maxScore": 12
    }
  ]
}
