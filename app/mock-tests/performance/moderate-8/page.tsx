...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Moderate 8",
  "subtitle": "Grade 4 PEP Moderate Practice Task",
  "introduction": "Read the sources about environmental care in Jamaica. Then answer the questions. Use details from more than one source when needed.",
  "difficultyLabel": "Moderate • Standard Grade 4 PEP level with inference and evidence use",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Jamaica's Natural Environment",
      "content": "Jamaica is home to many different ecosystems including forests, rivers, coral reefs, and wetlands. These natural areas are important because they provide clean air and water, support wildlife, and protect the island from flooding and erosion. Jamaica's biodiversity, the variety of plants and animals living here, is among the richest in the Caribbean region."
    },
    {
      "id": 2,
      "title": "Source 2: Threats to the Environment",
      "content": "Human activities are putting Jamaica's natural environment under pressure. Pollution from rubbish and chemicals can harm rivers, coastlines, and wildlife. Deforestation removes the trees that hold soil in place and provide habitat for animals. Illegal dumping of waste in rivers and gullies is a problem in many parishes. Without action, some plant and animal species could be lost forever."
    },
    {
      "id": 3,
      "title": "Source 3: Environmental Champions",
      "content": "Students at a school in St. James participated in a river clean-up and tree-planting project. They collected bags of rubbish from a local river and planted twelve fruit trees along the riverbank. One student said, 'I used to walk past that river every day and never thought about what I could do. Now I do.' The school plans to continue the project each term."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, why are Jamaica's natural areas important?",
      "options": [
        "They attract only foreign tourists",
        "They provide clean air and water, support wildlife, and protect against flooding",
        "They are used only for farming",
        "They supply electricity to homes"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 states that natural areas provide clean air and water, support wildlife, and protect the island from flooding and erosion.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does 'deforestation' most nearly mean?",
      "options": [
        "Planting more trees in forests",
        "The removal of trees from forested areas",
        "A type of water pollution",
        "A government programme for animals"
      ],
      "correctAnswer": 1,
      "explanation": "Deforestation means the clearing or removal of trees from forested areas, which is how it is used in Source 2.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "options": [
        "Rivers in Jamaica are not affected by human activity",
        "Human actions can both damage and help the environment",
        "Students should not get involved in environmental work",
        "Pollution has no effect on wildlife"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 shows how human actions damage the environment; Source 3 shows how students' actions can repair and protect it.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using Source 2, explain TWO threats to Jamaica's natural environment.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 threats",
        "Use source details"
      ],
      "reviewGuidance": "Include pollution from rubbish and chemicals harming rivers and wildlife, deforestation removing trees, illegal dumping, and the risk of losing plant and animal species.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "The student had always cared about the environment",
        "Awareness and action can shift a person's relationship with their surroundings",
        "Cleaning a river is too difficult for students",
        "The student only helped because they were forced to"
      ],
      "correctAnswer": 1,
      "explanation": "The student says they used to walk past without thinking about what they could do, but now they do, showing a shift in awareness and sense of responsibility.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "How do the sources show that protecting Jamaica's environment is both urgent and possible? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use information from at least 2 sources",
        "Explain clearly"
      ],
      "reviewGuidance": "Use Source 2 to show the urgency of threats and Source 3 to show that student action can make a real, visible difference to damaged environments.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school environmental newsletter about Jamaica's natural environment. Explain what makes it special, what threatens it, and what students can do to help protect it.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Describe Jamaica's environment",
        "Include threats and student action",
        "Use complete sentences"
      ],
      "reviewGuidance": "Introduce Jamaica's rich environment. Describe the threats from Source 2 clearly. End with specific actions students can take, using the river clean-up project as an example.",
      "maxScore": 12
    }
  ]
}
