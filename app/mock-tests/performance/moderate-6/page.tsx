...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Moderate 6",
  "subtitle": "Grade 4 PEP Moderate Practice Task",
  "introduction": "Read the sources about electricity and energy use in Jamaica. Then answer the questions. Use details from more than one source when needed.",
  "difficultyLabel": "Moderate • Standard Grade 4 PEP level with inference and evidence use",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: How We Use Electricity",
      "content": "Electricity is used in almost every part of daily life in Jamaica. It powers lights, fans, refrigerators, computers, televisions, and many other appliances. Schools, hospitals, businesses, and homes all depend on electricity to function properly. Most electricity in Jamaica is generated from fossil fuels such as oil, which must be imported from other countries."
    },
    {
      "id": 2,
      "title": "Source 2: Energy Challenges",
      "content": "Jamaica pays some of the highest electricity bills in the Caribbean. Because the island imports the oil used to generate power, prices rise when oil costs increase internationally. Blackouts and power cuts can disrupt school lessons and affect businesses. The government and energy companies are exploring ways to use more renewable energy, such as solar and wind power, to reduce costs and improve reliability."
    },
    {
      "id": 3,
      "title": "Source 3: Students Save Energy",
      "content": "One school in Kingston introduced an energy-saving campaign led by students. They identified appliances left on standby overnight and encouraged teachers to switch off lights in empty classrooms. Within two months, the school's electricity bill had dropped by fifteen percent. 'We did not think small actions could add up to so much,' said one student involved in the project."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, where does most of Jamaica's electricity come from?",
      "options": [
        "Solar panels on rooftops",
        "Wind turbines across the island",
        "Fossil fuels such as oil that are imported",
        "Hydroelectric dams on rivers"
      ],
      "correctAnswer": 2,
      "explanation": "Source 1 states that most electricity in Jamaica is generated from fossil fuels such as oil, which must be imported.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, what does 'renewable' most nearly mean?",
      "options": [
        "Old and no longer used",
        "Energy that runs out quickly",
        "Energy from natural sources that can be used repeatedly",
        "A type of oil imported from abroad"
      ],
      "correctAnswer": 2,
      "explanation": "Renewable energy comes from natural sources like solar or wind that are replenished naturally and can be used repeatedly without running out.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "options": [
        "Electricity costs have no effect on schools",
        "Reducing electricity use can have a real positive impact on costs",
        "Jamaica does not need electricity",
        "Students cannot help with energy problems"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 explains the high costs of electricity; Source 3 shows a school reducing its bill by 15% through student-led energy-saving actions.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Using Source 2, explain TWO problems caused by Jamaica's dependence on imported oil for electricity.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Give 2 problems",
        "Use source details"
      ],
      "reviewGuidance": "Include high electricity bills, price rises when international oil costs increase, blackouts disrupting schools and businesses, and the need to find renewable alternatives.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "The school had already saved energy before the campaign",
        "Small collective actions can produce larger results than expected",
        "Energy saving is only possible in large schools",
        "Students found the campaign boring"
      ],
      "correctAnswer": 1,
      "explanation": "The student says they did not think small actions could add up to so much, inferring that the cumulative impact of many small steps was greater than anticipated.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "How do the sources show that students can play a role in addressing energy challenges in Jamaica? Use information from at least TWO sources.",
      "guidelines": [
        "Write 3-4 complete sentences",
        "Use information from at least 2 sources",
        "Explain clearly"
      ],
      "reviewGuidance": "Connect the real challenges of high costs and dependence on oil from Sources 1 and 2 with the practical student-led results from Source 3.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school newsletter about electricity and energy use in Jamaica. Explain how electricity is used, the challenges Jamaica faces, and what students can do to help.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Include how electricity is used and the challenges",
        "Show what students can do",
        "Use complete sentences"
      ],
      "reviewGuidance": "Introduce electricity's role in daily life. Explain the problems of dependence on imported oil. End with practical actions students can take, using the school campaign as an example.",
      "maxScore": 12
    }
  ]
}
