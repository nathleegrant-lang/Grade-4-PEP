...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Difficult 9",
  "subtitle": "Grade 4 PEP Difficult Practice Task",
  "introduction": "Read the sources about climate change and its effects on Jamaica. Then answer the task parts. Some questions will ask you to connect ideas across the sources.",
  "difficultyLabel": "Difficult • Closer reading, stronger inference, and deeper explanation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: What Is Climate Change?",
      "content": "Climate change refers to long-term shifts in global temperatures and weather patterns. While some change is natural, scientists have found that human activities, especially burning fossil fuels like coal and oil, have significantly increased the amount of carbon dioxide in the atmosphere. This traps heat and causes the planet to warm. The effects include rising sea levels, more intense storms, longer droughts, and changes in rainfall patterns across the world."
    },
    {
      "id": 2,
      "title": "Source 2: How Climate Change Affects Jamaica",
      "content": "Jamaica is particularly vulnerable to climate change because of its small size and island location. Rising sea levels threaten low-lying coastal communities, and stronger hurricanes bring greater damage. Coral reefs, which protect coastlines and support fishermen, are bleaching and dying due to warmer ocean temperatures. Farmers face unpredictable rainfall and longer dry seasons, which can ruin crops. These effects harm Jamaica's economy, food supply, and natural environment."
    },
    {
      "id": 3,
      "title": "Source 3: Taking Action at School and at Home",
      "content": "Schools in Jamaica are finding ways to teach students about climate change and what they can do about it. Students learn to save energy by switching off lights and fans when not needed. Tree-planting projects help to absorb carbon dioxide. One student who participated in a school energy audit said, 'I found so many ways we were wasting energy without even realising it.' These small steps, taken by many people, can add up to meaningful change."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what is the main human cause of climate change?",
      "options": [
        "Planting too many trees",
        "Burning fossil fuels such as coal and oil",
        "Building too many schools and hospitals",
        "Using renewable energy sources"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 explains that burning fossil fuels significantly increases carbon dioxide in the atmosphere, causing warming.",
      "maxScore": 2
    },
    {
      "id": 2,
      "title": "Part B: Understanding Effects",
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, why are coral reefs described as important to Jamaica?",
      "options": [
        "They provide fresh water for farming",
        "They are used to build coastal roads",
        "They protect coastlines and support fishermen",
        "They attract oil companies to the island"
      ],
      "correctAnswer": 2,
      "explanation": "Source 2 states that coral reefs protect coastlines and support fishermen.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the student's comment in Source 3 suggest about energy use in schools?",
      "options": [
        "Schools already use energy perfectly efficiently",
        "Students and schools often waste energy without being aware of it",
        "Energy audits are too complicated for students",
        "Saving energy is only possible in large factories"
      ],
      "correctAnswer": 1,
      "explanation": "The student's surprise at finding many examples of energy waste suggests that people often do not notice their own wasteful habits.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Explain TWO ways that climate change harms Jamaica, based on the sources.",
      "guidelines": [
        "Write 2–3 complete sentences",
        "Name and explain 2 specific effects",
        "Use details from the sources"
      ],
      "reviewGuidance": "Consider rising sea levels, stronger hurricanes, dying coral reefs, and damage to farmers and crops.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "options": [
        "The causes of climate change described in Source 1 help explain why the actions in Source 3 are needed",
        "Source 1 says humans have no effect on climate",
        "Source 3 shows that only governments can slow climate change",
        "Burning fossil fuels is the main activity taught in school energy audits"
      ],
      "correctAnswer": 0,
      "explanation": "Understanding that human activities cause climate change (Source 1) makes the student actions to reduce energy use (Source 3) clearly relevant.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why should students in Jamaica learn about climate change and take action against it? Use information from at least TWO sources to support your answer.",
      "guidelines": [
        "Write 3–4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your reasoning"
      ],
      "reviewGuidance": "Connect Jamaica's specific vulnerabilities with how student awareness and small daily actions can contribute to wider change.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an informative article for your school newsletter explaining what climate change is, how it affects Jamaica, and what students can do to help. Use all three sources in your response.",
      "guidelines": [
        "Write at least 3 paragraphs",
        "Use information from all 3 sources",
        "Explain ideas clearly and fully",
        "Use complete sentences"
      ],
      "reviewGuidance": "Start by explaining what climate change is and why it happens. Describe the specific effects on Jamaica. End by describing realistic student and school actions, with examples from Source 3.",
      "maxScore": 12
    }
  ]
}
