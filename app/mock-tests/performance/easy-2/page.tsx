...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Easy 2",
  "subtitle": "Grade 4 PEP Easy Practice Task",
  "introduction": "Read the sources about Jamaica's Blue Mountains. Then answer the questions that follow. Use the information from the sources to help you.",
  "difficultyLabel": "Easy • Clear facts, direct evidence, and simpler writing support",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: The Blue Mountains",
      "content": "The Blue Mountains are found in the eastern part of Jamaica. They are the highest mountains on the island. The mountains got their name from the blue mist that often covers them. Many rivers and streams begin in the Blue Mountains. The air there is cool and fresh."
    },
    {
      "id": 2,
      "title": "Source 2: Life in the Blue Mountains",
      "content": "Many plants and animals live in the Blue Mountains. There are tall trees, colourful birds, and small animals like frogs. Farmers grow coffee in the mountains. Blue Mountain Coffee is known all over the world. People visit the area to enjoy nature and the cool weather."
    },
    {
      "id": 3,
      "title": "Source 3: Visiting the Blue Mountains",
      "content": "The Blue Mountains are a popular place to visit. Hikers walk along paths to see the views. On a clear day, you can see far across Jamaica and even out to sea. There are also small towns and communities in the mountains where people live and work."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, where are the Blue Mountains found?",
      "options": [
        "In the west of Jamaica",
        "In the north of Jamaica",
        "In the eastern part of Jamaica",
        "Near Kingston city centre"
      ],
      "correctAnswer": 2,
      "explanation": "Source 1 states that the Blue Mountains are found in the eastern part of Jamaica.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what crop is grown in the Blue Mountains?",
      "options": [
        "Bananas",
        "Sugar cane",
        "Coffee",
      ...
      "correctAnswer": 2,
      "explanation": "Source 2 says farmers grow coffee in the Blue Mountains.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What do Source 1 and Source 3 both tell us about the Blue Mountains?",
      "options": [
        "They are flat and easy to walk across",
        "They are a popular place for farming only",
        "They are high and have beautiful views",
        "They are found near the south coast"
      ],
      "correctAnswer": 2,
      "explanation": "Source 1 says the mountains are the highest on the island, and Source 3 describes the views visitors can enjoy.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Give TWO facts about the Blue Mountains from the sources. Write in complete sentences.",
      "guidelines": [
        "Write 2 complete sentences",
        "Give 2 correct facts",
        "Use your own words"
      ],
      "reviewGuidance": "Choose two clear facts, such as the mountains' location, the rivers that begin there, the coffee grown, or the views for visitors.",
      "maxScore": 4,
    ...
    },
    {
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "Why is Blue Mountain Coffee special?",
      "options": [
        "It is only sold in the mountains",
        "It is known all over the world",
        "It grows only at the beach",
        "It has no taste"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 says Blue Mountain Coffee is known all over the world.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Explain why people enjoy visiting the Blue Mountains.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Use information from the sources"
      ],
      "reviewGuidance": "Mention the cool weather, beautiful views, nature walks, and the chance to see across Jamaica and out to sea.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a short article for your class booklet about the Blue Mountains. Tell what they are, what lives or grows there, and why they are worth visiting.",
      "guidelines": [
        "Write at least 2 paragraphs",
        "Use facts from the sources",
        "Write in complete sentences"
      ],
      "reviewGuidance": "Introduce the Blue Mountains and where they are. Describe what makes them special. Explain why visitors enjoy the area.",
      "maxScore": 12
    }
  ]
}
