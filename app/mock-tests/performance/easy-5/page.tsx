...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Easy 5",
  "subtitle": "Grade 4 PEP Easy Practice Task",
  "introduction": "Read the sources about Jamaica's national fruit, the ackee. Then answer the questions that follow. Use the information from the sources to help you.",
  "difficultyLabel": "Easy • Clear facts, direct evidence, and simpler writing support",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: What Is the Ackee?",
      "content": "The ackee is Jamaica's national fruit. It came to Jamaica from West Africa. The ackee grows on trees and has a bright red skin when it is ripe. Inside, the fruit is yellow and soft. Only the yellow part is safe to eat. The ackee must be opened naturally before it is picked."
    },
    {
      "id": 2,
      "title": "Source 2: Ackee in Jamaican Food",
      "content": "Ackee is used in many Jamaican meals. The most famous dish is ackee and saltfish. This dish is Jamaica's national dish. Ackee can also be cooked with vegetables and used in other recipes. Many Jamaicans eat ackee for breakfast. The fruit is also exported to other countries."
    },
    {
      "id": 3,
      "title": "Source 3: The Ackee Tree",
      "content": "The ackee tree is an evergreen tree that grows well in Jamaica's warm climate. It produces fruit several times each year. The tree has glossy green leaves and small white flowers. Ackee trees are grown in many parishes across Jamaica. The fruit is an important part of Jamaican culture and cooking."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, where did the ackee originally come from?",
      "options": [
        "South America",
        "West Africa",
        "England",
      ...
      "correctAnswer": 1,
      "explanation": "Source 1 says the ackee came to Jamaica from West Africa.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what is Jamaica's national dish?",
      "options": [
        "Jerk chicken",
        "Rice and peas",
        "Ackee and saltfish",
      ...
      "correctAnswer": 2,
      "explanation": "Source 2 states that ackee and saltfish is Jamaica's national dish.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What do Sources 1 and 3 both tell us about the ackee?",
      "options": [
        "It only grows in one parish",
        "It can be eaten raw at any time",
        "It is an important part of Jamaican life",
        "It is only used in drinks"
      ],
      "correctAnswer": 2,
      "explanation": "Both sources show that the ackee is important to Jamaica, whether as the national fruit or as part of its culture and cooking.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Give TWO facts about the ackee from the sources. Write in complete sentences.",
      "guidelines": [
        "Write 2 complete sentences",
        "Give 2 correct facts",
        "Use your own words"
      ],
      "reviewGuidance": "Choose two clear facts, such as where it came from, what colour it is when ripe, what meal it is used in, or how the tree grows.",
      "maxScore": 4,
    ...
    },
    {
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "Why is the ackee important to Jamaica?",
      "options": [
        "It is only grown for export",
        "It is a national symbol and used in Jamaican cooking",
        "It replaces all other fruits in Jamaica",
        "It is the most expensive fruit in the world"
      ],
      "correctAnswer": 1,
      "explanation": "The sources explain that the ackee is the national fruit and a key ingredient in Jamaica's national dish and culture.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Explain how the ackee is used in Jamaican food and life.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Use information from the sources"
      ],
      "reviewGuidance": "Mention ackee and saltfish as the national dish, other cooking uses, breakfast traditions, and that it is exported to other countries.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a short article for your class booklet about the ackee. Tell what it is, how it is used, and why it is important to Jamaica.",
      "guidelines": [
        "Write at least 2 paragraphs",
        "Use facts from the sources",
        "Write in complete sentences"
      ],
      "reviewGuidance": "Introduce what the ackee is and where it comes from. Explain how it is cooked and eaten. End by explaining its importance as a national symbol.",
      "maxScore": 12
    }
  ]
}
