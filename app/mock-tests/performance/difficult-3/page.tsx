...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Difficult 3",
  "subtitle": "Grade 4 PEP Difficult Practice Task",
  "introduction": "Read the sources about hurricanes and how Jamaica prepares for them. Then answer the task parts. Some questions will ask you to think carefully about what the sources suggest.",
  "difficultyLabel": "Difficult • Closer reading, stronger inference, and deeper explanation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Understanding Hurricanes",
      "content": "A hurricane is a powerful storm that forms over warm ocean water. It brings very strong winds, heavy rain, and large waves. Hurricanes are measured on a scale from Category 1 to Category 5, with Category 5 being the most destructive. Jamaica lies in an area known as the Caribbean Hurricane Belt, which means the island can be affected by hurricanes especially between June and November each year."
    },
    {
      "id": 2,
      "title": "Source 2: How Jamaica Prepares",
      "content": "The Jamaican government and disaster agencies work together to help communities prepare for hurricanes. People are advised to keep emergency kits with food, water, medicines, and important documents. Communities are told to learn their evacuation routes and to listen carefully for official warnings. Schools also practise hurricane drills so that students know what to do if a storm strikes while they are in class."
    },
    {
      "id": 3,
      "title": "Source 3: After the Storm",
      "content": "When a hurricane passes, communities often face damage to roads, homes, and crops. Electricity and clean water may be cut off for days or weeks. Aid workers and volunteers help with clean-up and with delivering supplies to those in need. One community leader in Jamaica said, 'The people who recover best are those who prepared early and helped each other.' Recovery takes time, but strong communities can rebuild."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, when is Jamaica most likely to be affected by hurricanes?",
      "options": [
        "January to March",
        "March to May",
        "June to November",
      ...
      "correctAnswer": 2,
      "explanation": "Source 1 states that hurricanes affect Jamaica especially between June and November each year.",
      "maxScore": 2
    },
    {
      "id": 2,
      "title": "Part B: Understanding Details",
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, which of the following is NOT mentioned as part of an emergency kit?",
      "options": [
        "Food and water",
        "Important documents",
      ...
      "correctAnswer": 2,
      "explanation": "Source 2 mentions food, water, medicines, and important documents, but does not specifically mention a torch.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the community leader's comment in Source 3 suggest about recovery after a hurricane?",
      "options": [
        "Recovery is only possible with government help",
        "Communities that were prepared and worked together recover more successfully",
        "Hurricanes always destroy everything permanently",
        "Aid workers do all of the rebuilding"
      ],
      "correctAnswer": 1,
      "explanation": "The leader's comment highlights that preparation and community cooperation are key to successful recovery.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Explain TWO ways that communities or schools can prepare for a hurricane before it arrives.",
      "guidelines": [
        "Write 2–3 complete sentences",
        "Give 2 clear preparation steps",
        "Use details from the sources"
      ],
      "reviewGuidance": "Think about emergency kits, evacuation routes, hurricane drills, and community warnings.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "Which statement best shows a connection between Source 2 and Source 3?",
      "options": [
        "Preparing before a hurricane makes recovery after it easier",
        "Emergency kits are not useful after a storm passes",
        "Category 5 storms always destroy all roads",
        "Volunteers only help in other countries"
      ],
      "correctAnswer": 0,
      "explanation": "Source 2 describes preparation steps, and Source 3 confirms that those who prepared early recover best.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why is it important for students to learn about hurricane preparedness? Use information from at least TWO sources to support your answer.",
      "guidelines": [
        "Write 3–4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your thinking clearly"
      ],
      "reviewGuidance": "Show that students face hurricane risk in Jamaica, that schools practise drills, and that communities that prepare recover better.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school magazine to help younger students understand what hurricanes are, how to prepare for them, and what recovery looks like. Use all three sources in your response.",
      "guidelines": [
      ...
      "reviewGuidance": "Introduce what hurricanes are and why Jamaica is at risk. Describe preparation clearly. End by explaining how communities recover and the importance of working together.",
      "maxScore": 12
    }
  ]
}
