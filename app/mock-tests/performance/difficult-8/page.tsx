...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Difficult 8",
  "subtitle": "Grade 4 PEP Difficult Practice Task",
  "introduction": "Read the sources about Jamaica's cultural heritage. Then answer the task parts. Some questions will ask you to connect ideas and think carefully about what the sources suggest.",
  "difficultyLabel": "Difficult • Closer reading, stronger inference, and deeper explanation",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: The Power of Jamaican Music",
      "content": "Jamaica has given the world some of its most influential music. Genres such as mento, ska, rocksteady, reggae, and dancehall each emerged at different points in Jamaican history, reflecting the social and political experiences of the time. Reggae music, made world-famous by artists like Bob Marley, carries messages of love, justice, and unity. In 2018, reggae was added to UNESCO's list of Intangible Cultural Heritage, recognising its global importance."
    },
    {
      "id": 2,
      "title": "Source 2: Preserving Cultural Traditions",
      "content": "Cultural heritage includes not just music but also language, food, festivals, craft, and storytelling. Jamaica's Patois language, folk songs, and traditions like Jonkonnu are all part of the island's living heritage. Some traditions are at risk of being forgotten as younger generations adopt new habits and technologies. Cultural organisations and schools work to document and celebrate these traditions so they are passed on to future generations."
    },
    {
      "id": 3,
      "title": "Source 3: Students as Culture Keepers",
      "content": "At several schools in Jamaica, students take part in cultural programmes that include learning traditional dances, cooking local recipes, and practising folk songs. One student said, 'I never knew that so much history was in the songs my grandmother used to sing.' Teachers argue that understanding one's cultural roots builds confidence and a sense of identity. When students engage with their heritage, they become ambassadors for it in the wider community."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, why was reggae added to UNESCO's list of Intangible Cultural Heritage in 2018?",
      "options": [
        "Because it is Jamaica's newest musical genre",
        "Because it was recognised for its global cultural importance",
        "Because it was created specifically for international audiences",
        "Because it replaced all other music in Jamaica"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 states that reggae was added to the UNESCO list in recognition of its global importance.",
      "maxScore": 2
    },
    {
      "id": 2,
      "title": "Part B: Understanding a Risk",
      "category": "reading",
      "type": "multiple-choice",
      "question": "In Source 2, why are some cultural traditions described as being at risk?",
      "options": [
        "Because they are no longer interesting to anyone",
        "Because younger generations are adopting new habits and technologies",
        "Because schools have banned traditional practices",
        "Because Jamaica has no organisations to protect culture"
      ],
      "correctAnswer": 1,
      "explanation": "Source 2 explains that some traditions risk being forgotten as younger generations adopt new habits and technologies.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What does the student's comment in Source 3 suggest about folk songs?",
      "options": [
        "Folk songs are only useful for entertainment",
        "Cultural meaning can be hidden in everyday practices that people take for granted",
        "Students do not enjoy learning traditional music",
        "Grandmothers should teach all cultural lessons"
      ],
      "correctAnswer": 1,
      "explanation": "The student's discovery that their grandmother's songs contained history shows how cultural knowledge can be embedded in everyday life without people realising it.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Explain TWO reasons why it is important to preserve Jamaica's cultural heritage.",
      "guidelines": [
        "Write 2–3 complete sentences",
        "Give 2 clear reasons",
        "Use details from the sources"
      ],
      "reviewGuidance": "Consider the messages in music, the risks of traditions being forgotten, identity and confidence, and passing heritage to future generations.",
      "maxScore": 4
    },
    {
      "id": 5,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "Which statement best connects Source 1 and Source 3?",
      "options": [
        "Reggae music is no longer relevant to Jamaican students",
        "The global recognition of Jamaican music in Source 1 supports the importance of students learning about their heritage in Source 3",
        "Students only learn about reggae, not older traditions",
        "UNESCO does not include student activities"
      ],
      "correctAnswer": 1,
      "explanation": "Source 1 shows that Jamaican culture has global value; Source 3 shows how students can connect with and carry that culture forward.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Why should schools invest time in teaching students about Jamaican cultural heritage? Use information from at least TWO sources to support your answer.",
      "guidelines": [
        "Write 3–4 complete sentences",
        "Use evidence from 2 sources",
        "Explain your reasoning"
      ],
      "reviewGuidance": "Link the global and historical importance of Jamaican culture with how school programmes build identity, confidence, and community ambassadorship.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write an article for your school magazine arguing that Jamaican cultural heritage should be celebrated and taught in schools. Use all three sources in your response.",
      "guidelines": [
      ...
      "reviewGuidance": "Open by explaining what Jamaican cultural heritage includes and why it matters. Describe the risk of losing traditions. End by making a strong case for student involvement as culture keepers.",
      "maxScore": 12
    }
  ]
}
