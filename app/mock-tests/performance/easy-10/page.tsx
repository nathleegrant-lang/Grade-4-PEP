...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Easy 10",
  "subtitle": "Grade 4 PEP Easy Practice Task",
  "introduction": "Read the sources about Jamaica's national symbols. Then answer the questions that follow. Use the information from the sources to help you.",
  "difficultyLabel": "Easy • Clear facts, direct evidence, and simpler writing support",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: The Jamaican Flag",
      "content": "Jamaica's flag has three colours: black, gold, and green. The flag has a gold diagonal cross that divides it into four sections. The two sections on the left and right are black. The sections at the top and bottom are green. Black stands for the strength of the Jamaican people. Gold stands for sunshine and natural resources. Green stands for hope and the land."
    },
    {
      "id": 2,
      "title": "Source 2: Other National Symbols",
      "content": "Jamaica has several national symbols. The national bird is the doctor bird, also called the streamer-tail hummingbird. The national flower is the lignum vitae flower, which is blue and purple. The national tree is also called the lignum vitae. The national fruit is the ackee. Each symbol was chosen because it represents something important about Jamaica."
    },
    {
      "id": 3,
      "title": "Source 3: Why National Symbols Matter",
      "content": "National symbols are important because they represent a country and its people. They help Jamaicans feel proud of their island. The flag is flown at schools, government buildings, and events. National symbols are taught in schools so that children know and love their country. When people see Jamaica's symbols, they are reminded of who they are and where they come from."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what does the colour green on the Jamaican flag represent?",
      "options": [
        "Sunshine and resources",
        "The strength of the people",
        "Hope and the land",
        "The sea around Jamaica"
      ],
      "correctAnswer": 2,
      "explanation": "Source 1 states that green on the Jamaican flag stands for hope and the land.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what is Jamaica's national flower?",
      "options": [
        "The hibiscus",
        "The bougainvillea",
      ...
      "correctAnswer": 2,
      "explanation": "Source 2 says the national flower is the lignum vitae flower.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What do Sources 1 and 3 both suggest about Jamaica's national symbols?",
      "options": [
        "Symbols are only for the government to use",
        "Symbols are not taught in schools",
        "Symbols represent Jamaica and make people feel proud",
        "Symbols were chosen by tourists"
      ],
      "correctAnswer": 2,
      "explanation": "Source 1 explains what the flag represents, and Source 3 says symbols help Jamaicans feel proud and remind them of who they are.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Give TWO facts about Jamaica's national symbols from the sources. Write in complete sentences.",
      "guidelines": [
        "Write 2 complete sentences",
        "Give 2 correct facts",
        "Use your own words"
      ],
      "reviewGuidance": "Choose two clear facts, such as the colours of the flag, what they mean, the national bird or flower, or why symbols are important.",
      "maxScore": 4,
    ...
    },
    {
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "Why are national symbols taught in schools?",
      "options": [
        "So children can draw them in art class",
        "So children know and love their country",
        "So children can make the flag themselves",
        "So teachers have something to show"
      ],
      "correctAnswer": 1,
      "explanation": "Source 3 says national symbols are taught in schools so that children know and love their country.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Explain why national symbols are important to the people of Jamaica.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Use information from the sources"
      ],
      "reviewGuidance": "Mention that symbols represent the country, help Jamaicans feel proud, and remind people of who they are and where they come from.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a short article for your class booklet about Jamaica's national symbols. Tell what the flag looks like, name some national symbols, and explain why they are important.",
      "guidelines": [
        "Write at least 2 paragraphs",
        "Use facts from the sources",
        "Write in complete sentences"
      ],
      "reviewGuidance": "Start by describing the Jamaican flag and what its colours mean. List and explain some other national symbols. End by explaining why national symbols matter to Jamaicans.",
      "maxScore": 12
    }
  ]
}
