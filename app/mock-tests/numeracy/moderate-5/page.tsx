...
const numeracyModerate5Questions: Question[] = [
  {
    id: 1,
    type: "number",
    ...
    correctAnswer: 1,
    explanation: `7,004 - 3,000 = 4,004. Then 4,004 - 867 = 3,137.`
  },
  {
    id: 2,
    type: "number",
  ...
  },
  {
    id: 3,
    type: "number",
    question: `What is 693 divided by 7?`,
    options: [
      "89",
      "91",
      "93",
    ...
    correctAnswer: 3,
    explanation: `693 / 7 = 99. Check: 99 x 7 = 693.`
  },
  {
    id: 4,
    type: "number",
  ...
  },
  {
    id: 5,
    type: "number",
    question: `Which of these numbers is divisible by both 2 and 9?`,
    options: [
      "28",
      "36",
      "44",
    ...
    correctAnswer: 1,
    explanation: `36: 36/2 = 18 and 36/9 = 4. Both divide evenly. 36 is correct.`
  },
  {
    id: 6,
    type: "number",
    ...
    correctAnswer: 1,
    explanation: `Convert 2/5 to tenths: 2/5 = 4/10. Then 7/10 - 4/10 = 3/10.`
  },
  {
    id: 7,
    type: "number",
  ...
  },
  {
    id: 8,
    type: "number",
    question: `Which is the value of the digit 4 in 2.475?`,
    options: [
      "4",
      "0.4",
      "0.04",
    ...
    correctAnswer: 1,
    explanation: `In 2.475, the digit 4 is in the tenths place. Its value is 0.4.`
  },
  {
    id: 9,
    type: "number",
    question: `Solve for n: 5n - 8 = 32`,
    options: [
      "6",
      "7",
      "8",
    ...
    correctAnswer: 2,
    explanation: `5n = 32 + 8 = 40. n = 40 / 5 = 8.`
  },
  {
    id: 10,
    type: "number",
  ...
  },
  {
    id: 11,
    type: "number",
    question: `A vendor bought 8 dozen eggs. How many eggs did she buy altogether?`,
    options: [
      "86",
      "92",
      "96",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: `2/5 x 100 = 200/5 = 40%.`
  },
  {
    id: 13,
    type: "number",
  ...
  },
  {
    id: 14,
    type: "number",
    question: `A number pattern starts: 3, 7, 11, 15, ___. What is the next number?`,
    options: [
      "17",
      "18",
      "19",
    ...
    correctAnswer: 2,
    explanation: `Each term increases by 4. 15 + 4 = 19.`
  },
  {
    id: 15,
    type: "number",
  ...
  },
  {
    id: 16,
    type: "measurement",
    question: `A square field has sides of 35 m. What is the area?`,
    options: [
      "70 m2",
      "140 m2",
      "1,225 m2",
    ...
    correctAnswer: 2,
    explanation: `Area of square = side x side = 35 x 35 = 1,225 m2.`
  },
  {
    id: 17,
    type: "measurement",
    question: `A bottle contains 1.75 litres of juice. How many 250 mL cups can be filled?`,
    options: [
      "5",
      "6",
      "7",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: `1 kg = 1,000 g. 4.25 x 1,000 = 4,250 g.`
  },
  {
    id: 20,
    type: "measurement",
    question: `A triangle has a base of 18 cm and a height of 10 cm. What is its area?`,
    options: [
      "28 cm2",
      "90 cm2",
      "180 cm2",
    ...
    correctAnswer: 1,
    explanation: `Area = 1/2 x base x height = 1/2 x 18 x 10 = 90 cm2.`
  },
  {
    id: 21,
    type: "measurement",
  ...
  },
  {
    id: 22,
    type: "measurement",
    question: `A rectangular floor is 8 m long and 5 m wide. What is the cost of tiling it at $12 per m2?`,
    options: [
      "$420",
      "$480",
      "$520",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: `9:55 to 11:00 = 1 hour 5 minutes. 11:00 to 11:20 = 20 minutes. Total = 1 hour 25 minutes.`
  },
  {
    id: 25,
    type: "measurement",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: `A cylinder has 2 flat circular faces (top and bottom) and 1 curved surface around the side.`
  },
  {
    id: 28,
    type: "geometry",
    question: `A shape is rotated 90 degrees clockwise. Which transformation has taken place?`,
    options: [
      "Translation",
      "Reflection",
      "Rotation",
  ...
  },
  {
    id: 29,
    type: "geometry",
    question: `Two angles of a triangle are 72 degrees and 48 degrees. What is the third angle?`,
    options: [
      "50 degrees",
      "55 degrees",
      "60 degrees",
    ...
    correctAnswer: 2,
    explanation: `Third angle = 180 - 72 - 48 = 60 degrees.`
  },
  {
    id: 30,
    type: "geometry",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: `A square-based pyramid has 4 base vertices and 1 apex = 5 vertices.`
  },
  {
    id: 32,
    type: "geometry",
    question: `Which of the following has no line of symmetry?`,
    options: [
    ...
    correctAnswer: 1,
    explanation: `A scalene triangle has all sides different and no line of symmetry.`
  },
  {
    id: 33,
    type: "geometry",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: `Arranged: 15, 19, 23, 28, 32, 36, 41. Middle (4th) value = 28.`
  },
  {
    id: 36,
    type: "statistics",
    question: `Goals scored in 7 matches: 2, 4, 1, 3, 4, 2, 4. What is the mode?`,
    options: [
      "1",
      "2",
      "3",
    ...
    correctAnswer: 3,
    explanation: `4 appears 3 times, which is the most frequent. Mode = 4.`
  },
  {
    id: 37,
    type: "statistics",
    question: `The range of a data set is 19. The smallest value is 14. What is the largest value?`,
    options: [
      "5",
      "19",
      "28",
  ...
  },
  {
    id: 38,
    type: "statistics",
    question: `A pie chart shows that 3/8 of students chose Science. If there are 40 students, how many chose Science?`,
    options: [
      "10",
      "12",
      "15",
    ...
    correctAnswer: 2,
    explanation: `3/8 of 40 = (3 x 40) / 8 = 120 / 8 = 15.`
  },
  {
    id: 39,
    type: "statistics",
...
export default function NumeracyModerate5MockTest() {
  ...
  const availableQuestions = isPremium ? numeracyModerate5Questions : numeracyModerate5Questions.slice(0, FREE_QUESTION_LIMIT)
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="max-w-2xl mx-auto shadow-lg">
            <CardHeader className="text-center bg-blue-50 rounded-t-lg">
              ...
              <CardTitle className="text-2xl text-blue-800">Numeracy Moderate 5</CardTitle>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="max-w-3xl mx-auto shadow-lg">
            <CardHeader className="text-center bg-blue-50 rounded-t-lg border-b">
              ...
              <p className="text-gray-600 mt-2">Grade 4 PEP Numeracy Moderate 5</p>
            </CardHeader>
            <CardContent className="p-6">
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <CardTitle className="text-2xl text-blue-800 mt-1">Grade 4 PEP Numeracy Moderate 5 Report</CardTitle>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold">Numeracy Moderate 5</h1>
