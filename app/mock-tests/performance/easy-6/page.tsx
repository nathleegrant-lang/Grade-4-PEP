...
const performanceTask: PerformanceTaskSet = {
  "title": "Performance Easy 6",
  "subtitle": "Grade 4 PEP Easy Practice Task",
  "introduction": "Read the sources about trees and plants in Jamaica. Then answer the questions that follow. Use the information from the sources to help you.",
  "difficultyLabel": "Easy • Clear facts, direct evidence, and simpler writing support",
  "sources": [
    {
      "id": 1,
      "title": "Source 1: Why Trees Are Important",
      "content": "Trees are very important for all living things. They give us clean air to breathe. Their roots hold the soil in place so it does not wash away. Trees provide shade and keep the land cool. Many animals make their homes in trees. Jamaica has many different types of trees, including the lignum vitae, which is the national tree."
    },
    {
      "id": 2,
      "title": "Source 2: Plants We Use Every Day",
      "content": "Many plants in Jamaica are useful to people. Breadfruit, plantain, mango, and coconut trees provide food. Some plants are used as medicines. Aloe vera is used to soothe skin. Mint and cerasee are made into teas. People also use plants to decorate their homes and gardens."
    },
    {
      "id": 3,
      "title": "Source 3: Caring for Plants",
      "content": "Taking care of plants is important for our communities. Students in many schools water plants, grow small gardens, and plant trees. When people cut down trees without replacing them, problems like flooding and soil loss can happen. Communities that protect their trees and plants have a cleaner, greener environment."
    }
  ],
  "parts": [
    {
      ...
      "question": "According to Source 1, what is Jamaica's national tree?",
      "options": [
        "Mango tree",
        "Coconut tree",
        "Lignum vitae",
      ...
      "correctAnswer": 2,
      "explanation": "Source 1 says the lignum vitae is Jamaica's national tree.",
      "maxScore": 2
    },
    {
      "id": 2,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "According to Source 2, what is aloe vera used for?",
      "options": [
        "Making tea",
        "Soothing skin",
        "Cooking food",
      ...
      "correctAnswer": 1,
      "explanation": "Source 2 says aloe vera is used to soothe skin.",
      "maxScore": 2
    },
    {
      "id": 3,
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What do Sources 1 and 3 both suggest about trees?",
      "options": [
        "Trees are only useful for making furniture",
        "Trees can cause problems for communities",
        "Cutting too many trees causes problems that affect the environment",
        "Trees grow better when they are cut down"
      ],
      "correctAnswer": 2,
      "explanation": "Source 1 shows trees hold soil and provide clean air; Source 3 says cutting them without replanting causes flooding and soil loss.",
      "maxScore": 2
    },
    {
      "id": 4,
      ...
      "type": "short-answer",
      "question": "Give TWO ways that plants or trees are useful to people in Jamaica. Write in complete sentences.",
      "guidelines": [
        "Write 2 complete sentences",
        "Give 2 correct ways",
        "Use your own words"
      ],
      "reviewGuidance": "Choose two clear points, such as providing food, giving clean air, providing shade, being used as medicines, or decorating homes.",
      "maxScore": 4,
    ...
    },
    {
      ...
      "category": "reading",
      "type": "multiple-choice",
      "question": "What happens when people cut down too many trees?",
      "options": [
        "The soil becomes stronger",
        "The air gets cleaner",
        "Flooding and soil loss can happen",
        "Birds find new homes easily"
      ],
      "correctAnswer": 2,
      "explanation": "Source 3 says that when people cut down trees without replacing them, flooding and soil loss can happen.",
      "maxScore": 2
    },
    {
      "id": 6,
      ...
      "category": "short-response",
      "type": "short-answer",
      "question": "Explain why it is important to take care of trees and plants.",
      "guidelines": [
        "Write 2-3 complete sentences",
        "Use information from the sources"
      ],
      "reviewGuidance": "Mention the clean air, shade, and homes trees provide, and how cutting them without replanting causes flooding and soil loss.",
      "maxScore": 6
    },
    {
      "id": 7,
      ...
      "question": "Write a short article for your class booklet about trees and plants in Jamaica. Tell why they are important, how we use them, and how we can take care of them.",
      "guidelines": [
        "Write at least 2 paragraphs",
        "Use facts from the sources",
        "Write in complete sentences"
      ],
      "reviewGuidance": "Start by explaining why trees and plants matter to people and animals. Give examples of how plants are used every day. End with how students and communities can help protect them.",
      "maxScore": 12
    }
  ]
}
